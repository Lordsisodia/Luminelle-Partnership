...
#
# Run from repo root:
#   ./docs/.blackbox/scripts/start-10h-monitor.sh --feature-research-synth docs/.blackbox/.plans/<synth>
# Or from within docs/:
#   ./.blackbox/scripts/start-10h-monitor.sh --feature-research-synth .blackbox/.plans/<synth>
...
"$docs_root/.blackbox/scripts/validate-loop.sh" "${args[@]}"
