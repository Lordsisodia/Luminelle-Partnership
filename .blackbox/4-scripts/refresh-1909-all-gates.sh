...
sed -n '1,220p' .blackbox/scripts/refresh-1909-all-gates.sh > "$SNP/docs-blackbox-scripts-refresh-1909-all-gates.sh.head220.txt" || true
sed -n '1,200p' .blackbox/scripts/refresh-1909-contract-evidence.sh > "$SNP/docs-blackbox-scripts-refresh-1909-contract-evidence.sh.head200.txt" || true
sed -n '1,220p' .blackbox/scripts/refresh-1909-stop-point-dashboard.sh > "$SNP/docs-blackbox-scripts-refresh-1909-stop-point-dashboard.sh.head220.txt" || true
./.blackbox/scripts/check-blackbox.sh > "$SNP/check-blackbox.${ts_compact}.txt" || true
