...
- If you must write a token to disk temporarily, store it only in a gitignored local file like: `docs/.blackbox/.local/telegram.md`
...
- `docs/.blackbox/.local/telegram.md`
...
Artifacts: docs/.blackbox/.plans/2025-12-28_1815_deep-research-x/notes.md
Next: validate licensing + integration approach
```

## Tooling (local helper)
Use the helper script:
- `docs/.blackbox/scripts/notify-telegram.sh`
