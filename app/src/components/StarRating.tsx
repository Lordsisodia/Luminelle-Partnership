...
export const StarRating = ({ value, outOf = 5, size = 16 }: StarRatingProps) => {
  ...
  const HalfStar = () => (
    <svg width={size} height={size} viewBox="0 0 24 24" aria-hidden="true" className="drop-shadow-[0_0_6px_rgba(255,255,255,0.85)]" style={{ filter: 'drop-shadow(0 0 6px rgba(255,255,255,0.85))' }}>
      ...
      <path d="M12 .587l3.668 7.431 8.2 1.193-5.934 5.786 1.401 8.163L12 18.897l-7.335 3.863 1.401-8.163L.132 9.211l8.2-1.193L12 .587z" fill="url(#half)" stroke="white" strokeWidth="0.8" />
    </svg>
  )

  return (
    <span className="inline-flex items-center gap-1 rounded-full border border-white/70 bg-white/45 px-3 py-1 text-amber-500 shadow-[0_0_14px_rgba(255,255,255,0.8)] backdrop-blur-sm">
