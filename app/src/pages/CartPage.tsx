...
const EmptyCartState = () => (
  <div className="rounded-2xl border border-brand-blush/60 bg-white p-6 text-center text-brand-cocoa/70">
    ...
    <RouterLink to="/product/shower-cap" className="mt-4 inline-flex items-center justify-center rounded-full bg-brand-cocoa px-6 py-2.5 text-sm font-semibold text-white">
      Browse the shop
    </RouterLink>
  </div>
)
