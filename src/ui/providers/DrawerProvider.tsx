              ...
              <div className="pb-24">
                <nav className="px-2 py-2">
                  <RouterLink
                    ...
                    className="block rounded-xl px-3 py-3 text-sm font-semibold text-brand-cocoa hover:bg-brand-blush/40"
                  ...
                  >
                    <div className="flex items-center justify-between">
                      ...
                      <span className="ml-2 rounded-full bg-brand-blush/60 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wide text-brand-cocoa/70">
                        Best Seller
                      </span>
                    </div>
                  </RouterLink>
                  <RouterLink
                    ...
                    className="mt-1 block h-12 rounded-xl px-3 text-sm font-medium text-brand-cocoa hover:bg-brand-blush/40 leading-[48px]"
