...
const sections = [
  ...
  },
  {
    ...
    body: (
      <p>
        We use cookies and similar technologies for core functionality (cart, checkout), analytics, and marketing. You can
        manage preferences in your browser settings; blocking some cookies may impact site features.
      </p>
    ),
  },
  {
