            ...
            <div className="mt-3 flex flex-col gap-3 text-sm md:items-start">
              <div className="flex flex-wrap items-baseline gap-3">
                <div className="flex items-baseline gap-2">
                  ...
                  <span className="text-3xl font-semibold text-semantic-text-primary">£14.99</span>
                </div>
              ...
              <a
                href={teaser.href}
                className="inline-flex items-center justify-center rounded-full border-2 border-semantic-legacy-brand-cocoa px-7 py-2.5 text-sm font-extrabold uppercase tracking-[0.08em] text-semantic-text-primary shadow-[0_10px_18px_rgba(0,0,0,0.1)] transition hover:-translate-y-0.5 hover:shadow-[0_12px_24px_rgba(0,0,0,0.14)] bg-white"
              >
                {teaser.ctaLabel}
              </a>
            </div>
