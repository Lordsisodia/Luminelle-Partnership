    ...
    <MarketingLayout navItems={[]} subtitle="Checkout">
      <section className="bg-white">
        <div className="mx-auto max-w-3xl px-4 py-14 md:px-6">
          <p className="text-xs font-semibold uppercase tracking-[0.28em] text-brand-cocoa/60">Checkout</p>
          <h1 className="mt-3 text-3xl font-semibold tracking-tight text-brand-cocoa">This checkout link can’t load here</h1>
          <p className="mt-4 text-sm leading-relaxed text-brand-cocoa/70">
            You’ve landed on a Shopify checkout/cart link (<span className="font-mono text-[12px] text-brand-cocoa">{fullPath}</span>).
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <RouterLink
              to="/cart"
              className="inline-flex items-center justify-center rounded-full bg-brand-cocoa px-6 py-3 text-sm font-semibold text-white"
            >
              Back to cart
            </RouterLink>
            <RouterLink
              to="/"
              className="inline-flex items-center justify-center rounded-full border border-brand-blush/60 bg-white px-6 py-3 text-sm font-semibold text-brand-cocoa"
            >
              Home
            </RouterLink>
          </div>

          <details className="mt-10 rounded-2xl border border-brand-blush/60 bg-brand-blush/10 p-5">
            <summary className="cursor-pointer text-sm font-semibold text-brand-cocoa">Developer details (why this happens + fix)</summary>
            <div className="mt-4 space-y-4 text-sm text-brand-cocoa/80">
              <p>
              ...
              <div className="space-y-2 rounded-xl border border-brand-blush/60 bg-white p-4">
                <div className="text-xs font-semibold uppercase tracking-[0.28em] text-brand-cocoa/60">Observed</div>
              ...
              <div className="space-y-2">
                <p className="font-semibold text-brand-cocoa">Fix options</p>
