...
export default function OrdersPage() {
  ...
  const selected = useMemo(() => (orderId ? MOCK_ORDERS.find((o) => o.id === orderId) ?? null : null), [orderId])
            ...
            {filtered.map((o) => (
              ...
              >
                ...
                <div className="mt-2 flex items-center justify-between text-[12px] text-semantic-text-primary/70">
                  ...
                  <span className="font-semibold text-semantic-text-primary">{formatMoney(o.total)}</span>
                </div>
              </button>
            ))}
          </div>
