...
import { Plug, ExternalLink, Settings, Clock, XCircle, ChevronDown, Loader2, Search, Home } from "lucide-react";
        ...
        <div className="integrations-settings-scope space-y-4 pb-32 text-siso-text-primary">
          ...
          <Breadcrumb className="text-white">
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator className="text-white/80" />
              <BreadcrumbItem>
                <BreadcrumbPage className="text-white">Integrations</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
          ...
          <HighlightCard
            color="orange"
            className="w-full max-w-none text-left integrations-card"
            title="Integrations"
