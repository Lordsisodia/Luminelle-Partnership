...
import { Shield, Download, Trash2, Eye, EyeOff, Users, Database, ChevronRight, FileText, History, CheckCircle, Clock, AlertCircle, Home } from "lucide-react";
      ...
      >
        ...
        <Breadcrumb className="text-white">
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator className="text-white/80" />
            <BreadcrumbItem>
              <BreadcrumbPage className="text-white">Privacy</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
        ...
        <div className="relative">
          <HighlightCard
            color="orange"
            className="w-full max-w-none text-left privacy-card"
            title="Privacy"
            ...
            <div className="m-1">
              <div className="rounded-[18px] border border-white/10 bg-white/5 p-4">
                <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                  ...
                  <Link
                    to={`${SETTINGS_ROUTES.privacy}/policy`}
