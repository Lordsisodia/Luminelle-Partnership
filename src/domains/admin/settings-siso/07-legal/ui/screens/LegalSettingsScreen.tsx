...
import { FileText, ChevronRight, BookOpen, Users, CreditCard, ShieldCheck, Cookie, History, Shield, Home } from "lucide-react";
        ...
        <div className="legal-settings-scope space-y-4 pb-32 text-siso-text-primary">
          ...
          <Breadcrumb className="text-white">
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator className="text-white/80" />
              <BreadcrumbItem>
                <BreadcrumbPage className="text-white">Legal</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
