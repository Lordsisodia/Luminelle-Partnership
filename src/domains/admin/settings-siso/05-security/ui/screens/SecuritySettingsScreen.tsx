...
import { Lock, Key, Shield, Smartphone, ChevronRight, MessageSquare, Mail, CreditCard, Home } from "lucide-react";
...
import { TwoFactorCards } from "@/domains/admin/settings-siso/02-my-account/ui/components/TwoFactorCards";
        ...
        <div className="security-settings-scope space-y-4 pb-32 text-siso-text-primary">
          <Breadcrumb className="text-white">
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator className="text-white/80" />
              <BreadcrumbItem>
                <BreadcrumbPage className="text-white">Security</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
          ...
          <div className="relative">
            <HighlightCard
              color="orange"
              className="w-full max-w-none text-left security-card"
              title="Security"
