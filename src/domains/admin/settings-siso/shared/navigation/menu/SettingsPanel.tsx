                ...
                <div
                  ...
                  onPointerEnter={() => {
                    if (item.id === "settings-account") {
                      void import("@/domains/admin/settings-siso/02-my-account/ui/screens/AccountSettingsView");
                    } else if (item.id === "settings-profile") {
                      void import("@/domains/admin/settings-siso/03-profile/ui/screens/ProfileSettingsView");
                    } else if (item.id === "settings-devices") {
                      void import("@/domains/admin/settings-siso/04-devices/ui/screens/ConnectedDevicesView");
                    }
                  }}
                  onTouchStart={() => {
                    if (item.id === "settings-account") {
