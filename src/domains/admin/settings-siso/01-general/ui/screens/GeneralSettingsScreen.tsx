...
import { useAppearanceSettings } from "@/domains/admin/settings-siso/01-general/application/sections/appearance/useAppearanceSettings";
import { useLanguageSettings } from "@/domains/admin/settings-siso/01-general/application/sections/language/useLanguageSettings";
            ...
            <section
              ...
              onPointerEnter={() => {
                if (id === "appearance") {
                  ...
                  void import("@/domains/admin/settings-siso/01-general/ui/notifications/AccountNotificationsView");
                } else if (id === "integrations") {
                  void import("@/domains/admin/settings-siso/08-integrations/ui/screens/IntegrationsSettingsScreen");
                }
              }}
              onTouchStart={() => {
                if (id === "notifications") {
