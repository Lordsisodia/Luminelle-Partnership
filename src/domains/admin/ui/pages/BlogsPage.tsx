      ...
      <div className="rounded-2xl border border-brand-blush/60 bg-white p-5">
        ...
        <div className="mt-4 grid gap-3 md:grid-cols-2">
          <div className="rounded-xl border border-brand-blush/60 bg-brand-porcelain/50 p-4">
            <div className="text-xs font-semibold uppercase tracking-[0.28em] text-brand-cocoa/60">Editor</div>
          ...
          <div className="rounded-xl border border-brand-blush/60 bg-brand-porcelain/50 p-4">
            <div className="text-xs font-semibold uppercase tracking-[0.28em] text-brand-cocoa/60">Publishing</div>
            <ul className="mt-2 list-disc space-y-1 pl-5 text-sm text-brand-cocoa/80">
