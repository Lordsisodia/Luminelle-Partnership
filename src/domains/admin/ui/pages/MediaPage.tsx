...
const MOCK_MEDIA: MediaItem[] = [
  ...
  },
  {
    ...
    usageCount: 2,
    createdAt: '2024-12-02',
    preview: '/uploads/luminele/2ND PHOTO.webp',
    breakpoint: 'desktop',
  },
  {
    id: 'scap-3rd-photo',
    ...
    usageCount: 2,
    createdAt: '2024-12-02',
    preview: '/uploads/luminele/3RD PHOTO.webp',
    breakpoint: 'desktop',
  },
  {
    id: 'scap-4th-photo',
    ...
    usageCount: 2,
    createdAt: '2024-12-02',
    preview: '/uploads/luminele/4TH PHOTO.webp',
    breakpoint: 'desktop',
  },
  {
    id: 'scap-5th-photo',
    ...
    usageCount: 1,
    createdAt: '2024-12-02',
    preview: '/uploads/luminele/5TH PHOTO.webp',
    breakpoint: 'desktop',
  },
  {
    id: 'scap-6th-photo',
    ...
    usageCount: 1,
    createdAt: '2024-12-02',
    preview: '/uploads/luminele/6TH PHOTO.webp',
    breakpoint: 'desktop',
  },
  {
    id: 'scap-7th-photo',
    ...
    usageCount: 1,
    createdAt: '2024-12-02',
    preview: '/uploads/luminele/7TH PHOTO.webp',
    breakpoint: 'desktop',
  },
  {
    id: 'scap-8th-photo',
    ...
    usageCount: 1,
    createdAt: '2024-12-02',
    preview: '/uploads/luminele/8TH PHOTO.webp',
    breakpoint: 'desktop',
  },
...
export default function MediaPage() {
  ...
  const [oversizeOnly, setOversizeOnly] = useState(false)
  const [density, setDensity] = useState<'cozy' | 'compact'>('cozy')
  const [bucketViews, setBucketViews] = useState<Record<string, 'grid' | 'list'>>(() =>
    Object.fromEntries(BUCKETS.map((b) => [b.id, 'grid'])) as Record<string, 'grid' | 'list'>
  )
  const [bucketSorts, setBucketSorts] = useState<Record<string, SortOption>>(() =>
    Object.fromEntries(BUCKETS.map((b) => [b.id, 'recent'])) as Record<string, SortOption>
  )
  const [bucketBreakpoints, setBucketBreakpoints] = useState<Record<string, BreakpointFilter>>(() =>
    Object.fromEntries(BUCKETS.map((b) => [b.id, 'all'])) as Record<string, BreakpointFilter>
  )
  ...
  const handleOpenUpload = (bucketId: string) => setUploadBucketId(bucketId)
  const handleCloseUpload = () => setUploadBucketId(null)
    ...
    <AdminPageLayout
      ...
      actions={
        <div className="flex flex-wrap items-center gap-2">
          <button
            onClick={() => setUploadBucketId('blog-media')}
              ...
              >
                <div className="flex flex-wrap items-center justify-between gap-3">
                  ...
                  {items.length === 0 ? (
                    ...
                    >
                      {items.map((item) => (
                        <MediaCard key={item.id} item={item} onSelect={() => setSelectedAsset(item)} />
                      ))}
                    </div>
                  ) : (
                    <div
                    ...
                    >
                      {items.map((item) => (
                        <MediaRow key={item.id} item={item} onSelect={() => setSelectedAsset(item)} density={density} />
                      ))}
                    </div>
                  )}
                </section>
