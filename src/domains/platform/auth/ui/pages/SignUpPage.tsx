    ...
    <div className="px-4 py-16">
      <div className="mx-auto flex max-w-5xl flex-col gap-10 rounded-[32px] bg-white p-6 shadow-2xl md:flex-row md:p-12">
        <div className="md:w-1/2">
          ...
          <h1 className="mt-4 font-heading text-3xl font-bold text-semantic-text-primary md:text-4xl">Join the creator program</h1>
          <p className="mt-3 text-semantic-text-primary/70">
            Create your account to access your Lumelle account hub and creator updates. Some account features (orders, saved addresses) are still being built.
          </p>
          <ul className="mt-6 space-y-3 text-semantic-text-primary/80">
            <li>• Join instantly with Google (no password)</li>
          ...
          <p className="mt-8 text-sm text-semantic-text-primary/70">
            ...
            <Link to={`/sign-in?redirect=${encodeURIComponent(redirectTo)}`} className="font-semibold text-semantic-text-primary">
              Sign in here
            </Link>
          </p>
        </div>
        ...
        <div className="md:w-1/2">
          <div className="rounded-3xl border border-semantic-legacy-brand-blush/60 bg-white/60 p-6 shadow-soft">
            <p className="text-xs font-semibold uppercase tracking-[0.28em] text-semantic-text-primary/60">Create your account</p>
            <h2 className="mt-2 text-2xl font-semibold text-semantic-text-primary">Join instantly with Google</h2>
            ...
            <div className="mt-6 space-y-4">
              ...
              <p className="text-xs text-semantic-text-primary/60">We’ll create your Lumelle creator profile using your Google account.</p>
            </div>
          </div>
        </div>
      </div>
