    ...
    >
      ...
      <div className="mt-10 grid gap-6 md:grid-cols-3">
        {journeySteps.map((step, idx) => (
          <div
            key={step.title}
            className="relative rounded-3xl border border-brand-peach/40 bg-white p-6 text-center shadow-sm transition hover:-translate-y-1 hover:shadow-soft"
          >
            ...
            <p className="mt-3 text-sm leading-relaxed text-brand-cocoa/70">
              {step.description}
            </p>
