...
export const successStories: SuccessStory[] = [
  ...
  },
  {
    ...
    highlight: 'Heatless curls test',
    stats: 'Comments asking for link',
    earnings: 'Repeat swipe-throughs',
    quote: 'Zero heat, zero frizz — loved how glossy it turned out.',
    badge: 'Creator Test',
  ...
  },
  {
    ...
    highlight: 'Satin curler demo',
    stats: 'Strong saves + shares',
    earnings: 'Healthy AOV from add-ons',
    quote: 'Wrapped in minutes, slept fine, curls actually held till the next day.',
    badge: 'UGC Demo',
  ...
  },
  {
    ...
    highlight: 'How-to wrap + bonnet',
    stats: 'Saves from “wrap with me”',
    earnings: 'Adds to cart after full watch',
    quote: 'Step-by-step wrap made it easy to follow along and get even curls.',
    badge: 'Tutorial',
