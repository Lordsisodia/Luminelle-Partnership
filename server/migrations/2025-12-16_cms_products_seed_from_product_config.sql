...
-- Source of truth (today): `src/domains/products/data/product-config.ts`
--
...
cross join (
  values
    ('/uploads/luminele/main (1).webp', 'Lumelle Shower Cap image 1', 0, true),
    ('/uploads/luminele/2ND PHOTO.webp', 'Lumelle Shower Cap image 2', 1, false),
    ('/uploads/luminele/3RD PHOTO.webp', 'Lumelle Shower Cap image 3', 2, false),
    ('/uploads/luminele/4TH PHOTO.webp', 'Lumelle Shower Cap image 4', 3, false),
    ('/uploads/luminele/5TH PHOTO.webp', 'Lumelle Shower Cap image 5', 4, false),
    ('/uploads/luminele/6TH PHOTO.webp', 'Lumelle Shower Cap image 6', 5, false),
    ('/uploads/luminele/7TH PHOTO.webp', 'Lumelle Shower Cap image 7', 6, false),
    ('/uploads/luminele/8TH PHOTO.webp', 'Lumelle Shower Cap image 8', 7, false)
...
-- ---------------------------------------------------------------------------
-- Satin Overnight Heatless Curler (set handle)
-- ---------------------------------------------------------------------------
with upsert as (
  insert into public.cms_products (
    handle,
...
cross join (
  values
    ('/uploads/curler/1.webp', 'Satin Overnight Curler Set image 1', 0, true),
    ('/uploads/curler/2.webp', 'Satin Overnight Curler Set image 2', 1, false),
    ('/uploads/curler/3.webp', 'Satin Overnight Curler Set image 3', 2, false),
    ('/uploads/curler/4.webp', 'Satin Overnight Curler Set image 4', 3, false),
    ('/uploads/curler/5.webp', 'Satin Overnight Curler Set image 5', 4, false),
    ('/uploads/curler/6.webp', 'Satin Overnight Curler Set image 6', 5, false)
) as m(path, alt, sort, is_primary)
on conflict (product_id, path) do update set
  alt = excluded.alt,
  sort = excluded.sort,
