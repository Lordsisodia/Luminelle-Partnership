...
Source audit (initial): `docs/reviews/app-ui-review-2025-12-26.md` (issues `1–180`).
...
Use these statuses in `docs/feedback/black-box/ui-issue-tracker.md`:
...
- Link to the audit issue (`docs/reviews/...` + issue number)
