...
- Use `docs/feedback/black-box/ui-issue-tracker.md` as the source of truth for status.
- Use `docs/feedback/black-box/ui-issues/issue-XXX.md` as the worklog for each issue.
- Follow the 7-step loop in `docs/feedback/black-box/ai-loop.md` for every issue.
...
Hard rules:
- Work on the `dev` branch only. Do not touch `main`.
- Use `docs/feedback/black-box/ui-issue-tracker.md` as the source of truth for status and scoring.
- Use per-issue worklogs under `docs/feedback/black-box/ui-issues/issue-XXX.md`.
- Follow the 7-step loop in `docs/feedback/black-box/ai-loop.md` for every issue (Step 1 → Step 7).
...
Workflow:
1) Open `docs/feedback/black-box/ui-issue-tracker.md`.
...
4) Open its worklog `docs/feedback/black-box/ui-issues/issue-XXX.md` and execute Step 1 through Step 7:
