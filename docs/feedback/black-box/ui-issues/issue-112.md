...
Source audit: `docs/reviews/app-ui-review-2025-12-26.md` — issue `112`
...
Audit (issue 112): `docs/reviews/app-ui-review-2025-12-26.md` — “Several key routes don’t set page metadata (tab title/description can be stale from the previous page)”.
...
- Audit: `docs/reviews/app-ui-review-2025-12-26.md` (issue 112)
- Code refs:
