...
Source audit: `docs/reviews/app-ui-review-2025-12-26.md` — issue `14`
...
- [x] Link to the audit issue and copy the key claim.
  - Audit issue `14` (`docs/reviews/app-ui-review-2025-12-26.md`): drawer quantity dropdown claims savings percentages that aren’t reflected in cart totals.
