# Issue 147: Admin product gallery selection can’t truly be closed (state forces `editingMediaIdx` back to 0)

Source audit: `docs/reviews/app-ui-review-2025-12-26.md` — issue `147`
