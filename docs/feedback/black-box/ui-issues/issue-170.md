...
Source audit: `docs/reviews/app-ui-review-2025-12-26.md` — issue `170`
...
Audit (issue 170): `docs/reviews/app-ui-review-2025-12-26.md` — “PDP bottom CTA chips are hard-coded to shower-cap features (‘Waterproof satin’, ‘No-frizz seal’) for every product”.
...
- Audit: `docs/reviews/app-ui-review-2025-12-26.md` (issue 170)
- Code refs:
