...
Source audit: `docs/reviews/app-ui-review-2025-12-26.md` — issue `78`
...
Audit (issue 78): `docs/reviews/app-ui-review-2025-12-26.md` — “`useMediaQuery` uses `matchMedia.addEventListener` only”.
...
- Audit: `docs/reviews/app-ui-review-2025-12-26.md` (issue 78)
- Code refs:
