...
Source audit: `docs/reviews/app-ui-review-2025-12-26.md` — issue `81`
...
Audit (issue 81): `docs/reviews/app-ui-review-2025-12-26.md` — “Header promo strip uses opacity-only hiding, so ‘hidden’ promos can still intercept clicks/focus”.
...
- Audit: `docs/reviews/app-ui-review-2025-12-26.md` (issue 81)
- Code refs:
