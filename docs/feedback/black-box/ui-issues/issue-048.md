# Issue 048: Blog “Shop now” CTAs use raw `<a href>` even for internal routes (full reload + state loss)

Source audit: `docs/reviews/app-ui-review-2025-12-26.md` — issue `48`
