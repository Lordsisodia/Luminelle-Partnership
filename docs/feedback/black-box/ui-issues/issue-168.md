...
Source audit: `docs/reviews/app-ui-review-2025-12-26.md` — issue `168`
...
Audit (issue 168): `docs/reviews/app-ui-review-2025-12-26.md` — “Client cart recovery env module mixes `process.env` with `import.meta.env` (browser-unsafe footgun)”.
...
- Audit: `docs/reviews/app-ui-review-2025-12-26.md` (issue 168)
- Code refs:
