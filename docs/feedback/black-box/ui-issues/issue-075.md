# Issue 075: Admin product cards say “Updated” but don’t show an updated timestamp (low utility + confusion)

Source audit: `docs/reviews/app-ui-review-2025-12-26.md` — issue `75`
