# Issue 103: Blog index “tag” chips look like filters but are inert, and pillar filtering is effectively unreachable

Source audit: `docs/reviews/app-ui-review-2025-12-26.md` — issue `103`
