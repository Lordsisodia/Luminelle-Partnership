...
Source audit: `docs/reviews/app-ui-review-2025-12-26.md` — issue `108`
...
Audit (issue 108): `docs/reviews/app-ui-review-2025-12-26.md` — “Shopify checkout/cart handoff page doesn’t provide a direct “Open on Shopify” link even when the domain is known”.
...
- Audit: `docs/reviews/app-ui-review-2025-12-26.md` (issue 108)
- Code refs:
