...
Source audit: `docs/reviews/app-ui-review-2025-12-26.md` — issue `83`
...
Audit (issue 83): `docs/reviews/app-ui-review-2025-12-26.md` — “PDP quantity picker uses ARIA ‘listbox’ semantics but lacks keyboard listbox behavior”.
...
- Audit: `docs/reviews/app-ui-review-2025-12-26.md` (issue 83)
- Code refs:
