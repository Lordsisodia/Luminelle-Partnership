...
Source audit: `docs/reviews/app-ui-review-2025-12-26.md` — issue `107`
...
- [x] Link to the audit issue and copy the key claim.
  - Audit issue `107` (`docs/reviews/app-ui-review-2025-12-26.md`): drawer upsells fabricate compare-at pricing + review counts.
