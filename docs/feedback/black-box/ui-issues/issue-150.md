...
Source audit: `docs/reviews/app-ui-review-2025-12-26.md` — issue `150`
...
Audit (issue 150): `docs/reviews/app-ui-review-2025-12-26.md` — “Drawer scroll-lock can cause horizontal “page jump” (scrollbar disappears with no compensation)”.
...
- Audit: `docs/reviews/app-ui-review-2025-12-26.md` (issue 150)
- Code refs:
