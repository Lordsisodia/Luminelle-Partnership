...
Source audit: `docs/reviews/app-ui-review-2025-12-26.md` — issue `13`
...
- [x] Link to the audit issue and copy the key claim.
  - Audit issue `13` (`docs/reviews/app-ui-review-2025-12-26.md`): the drawer invents compare-at pricing and shows “Total savings” based on it.
