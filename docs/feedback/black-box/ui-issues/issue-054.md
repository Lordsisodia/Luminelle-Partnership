...
Source audit: `docs/reviews/app-ui-review-2025-12-26.md` — issue `54`
...
Audit (issue 54): `docs/reviews/app-ui-review-2025-12-26.md` — “Unknown product handles fall back to the shower cap instead of a 404”.
...
- Audit: `docs/reviews/app-ui-review-2025-12-26.md` (issue 54)
- Code refs:
