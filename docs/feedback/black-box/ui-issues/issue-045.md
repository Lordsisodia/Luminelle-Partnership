...
Source audit: `docs/reviews/app-ui-review-2025-12-26.md` — issue `45`
...
- [x] Link to the audit issue and copy the key claim.
  - Audit issue `45` (`docs/reviews/app-ui-review-2025-12-26.md`): the drawer checkout button is disabled when `checkoutUrl` is missing, and `checkoutUrl` can be `undefined`, so the CTA never becomes actionable.
