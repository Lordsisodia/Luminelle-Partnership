# Issue 130: Duplicate `StarRating` components exist (UI drift + bug fixes won’t apply consistently)

Source audit: `docs/reviews/app-ui-review-2025-12-26.md` — issue `130`
