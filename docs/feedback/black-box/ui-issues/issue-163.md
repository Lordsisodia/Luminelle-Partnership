...
Source audit: `docs/reviews/app-ui-review-2025-12-26.md` — issue `163`
...
Audit (issue 163): `docs/reviews/app-ui-review-2025-12-26.md` — “`crypto.randomUUID()` is used without a fallback in browser-executed code”.
...
- Audit: `docs/reviews/app-ui-review-2025-12-26.md` (issue 163)
- Code refs:
