...
Source audit: `docs/reviews/app-ui-review-2025-12-26.md` — issue `5`
...
- [x] Link to the audit issue and copy the key claim.
  - Audit issue `5` (`docs/reviews/app-ui-review-2025-12-26.md`): cart line items showed a hard-coded image and hard-coded compare-at pricing.
