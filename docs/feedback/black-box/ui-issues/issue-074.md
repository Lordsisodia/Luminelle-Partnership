...
Source audit: `docs/reviews/app-ui-review-2025-12-26.md` — issue `74`
...
- [x] Link to the audit issue and copy the key claim.
  - Audit issue `74` (`docs/reviews/app-ui-review-2025-12-26.md`): cart help links and payment reassurance copy are shown even when the linked destinations/checkout path are unavailable.
