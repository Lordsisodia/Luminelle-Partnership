# Issue 145: Admin Products list silently hides any CMS products not present in `product-config` (admin ≠ source of truth)

Source audit: `docs/reviews/app-ui-review-2025-12-26.md` — issue `145`
