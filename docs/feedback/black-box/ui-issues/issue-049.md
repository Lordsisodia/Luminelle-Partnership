# Issue 049: Admin “Components” editor isn’t truly an admin system (localStorage-only, not publishable)

Source audit: `docs/reviews/app-ui-review-2025-12-26.md` — issue `49`
