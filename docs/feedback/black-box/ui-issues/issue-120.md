# Issue 120: Two different color token systems are used in global UI (`brand-*` vs `semantic-legacy-brand-*`) (design consistency drift risk)

Source audit: `docs/reviews/app-ui-review-2025-12-26.md` — issue `120`
