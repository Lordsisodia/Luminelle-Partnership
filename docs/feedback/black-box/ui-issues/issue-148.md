# Issue 148: Admin “Upload” relies on Cloudinary’s external widget script with no loading/progress UI (fragile + inconsistent asset pipeline)

Source audit: `docs/reviews/app-ui-review-2025-12-26.md` — issue `148`
...
## Step 7 — Record + Close
- [ ] Update `docs/feedback/black-box/ui-issue-tracker.md` (status + priority if changed).
