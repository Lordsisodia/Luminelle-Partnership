...
Source audit: `docs/reviews/app-ui-review-2025-12-26.md` — issue `91`
...
Audit claim (Issue 91): `docs/reviews/app-ui-review-2025-12-26.md` notes missing slugs linked from `src/content/blog/posts/lumelle-journal-launch.ts` and registered slugs in `src/content/blog/index.ts`.
