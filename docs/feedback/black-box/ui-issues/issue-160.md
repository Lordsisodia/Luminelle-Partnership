...
Source audit: `docs/reviews/app-ui-review-2025-12-26.md` — issue `160`
...
Audit (issue 160): `docs/reviews/app-ui-review-2025-12-26.md` — “Admin Products list can’t reliably open the editor (selection is cleared unless URL includes `/admin/products/:handle`)”.
