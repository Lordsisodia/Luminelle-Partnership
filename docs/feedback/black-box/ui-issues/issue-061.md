...
Source audit: `docs/reviews/app-ui-review-2025-12-26.md` — issue `61`
...
Audit claim (Issue 61): `docs/reviews/app-ui-review-2025-12-26.md` calls out `src/main.tsx` defaulting `VITE_CLERK_PUBLISHABLE_KEY` to `pk_test_placeholder`, causing auth to “silently break”.
