# Issue 018: Discounts / promo codes / rewards UI is present but the underlying logic is stubbed

Source audit: `docs/reviews/app-ui-review-2025-12-26.md` — issue `18`
