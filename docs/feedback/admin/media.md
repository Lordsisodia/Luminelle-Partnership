...
## Purpose
Manage assets (uploads, library, reuse, metadata, optimization).
...
- [ ] (#59) Media library is in-memory mock content; add “Demo UI” labeling or wire to real storage + persistence. — Black-box: `UNTRIAGED` ([issue-059](../black-box/ui-issues/issue-059.md))
