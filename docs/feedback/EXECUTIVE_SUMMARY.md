...
- `docs/feedback/README.md` (how feedback is organized)
- `docs/feedback/black-box/README.md` (AI-executable UI backlog system)
- `docs/feedback/black-box/ui-issue-tracker.md` (single source of truth for the 2025-12-26 UI audit)
...
1) **Time-based snapshots** (`docs/feedback/YYYY-MM-DD-*.md`)
   - Immutable-ish raw notes (calls, transcripts, screenshots, Looms, etc.)
   - Example: `docs/feedback/2025-11-13-client-call.md`
...
## Black-box UI audit status (2025-12-26)

The internal UI audit (`docs/reviews/app-ui-review-2025-12-26.md`) has been converted into:

- **Tracker:** `docs/feedback/black-box/ui-issue-tracker.md`
- **Per-issue worklogs (180):** `docs/feedback/black-box/ui-issues/issue-*.md`
...
There are **47 unique** `codex-clipboard-*.png` references across `docs/feedback/**/*.md`, and **none** of those files exist in `docs/feedback/Feedback images/`.

Action:
- If you have those screenshots, drop them into `docs/feedback/Feedback images/` and update the notes to link to the real filenames.
