...
- [x] (#2) Order tracking is a stub (“temporarily unavailable”); ship a branded tracking entry + status page (or redirect to a real tracking provider). — Black-box: `DONE` ([issue-002](../black-box/ui-issues/issue-002.md))
