...
- [x] (#2) Order confirmation is a stub (“temporarily unavailable”); replace with a branded confirmation page or redirect/embed Shopify confirmation safely. — Black-box: `DONE` ([issue-002](../black-box/ui-issues/issue-002.md))
