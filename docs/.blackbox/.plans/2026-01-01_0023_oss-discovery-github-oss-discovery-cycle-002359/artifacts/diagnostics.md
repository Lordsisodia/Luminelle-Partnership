...
Plan: `.blackbox/.plans/2026-01-01_0023_oss-discovery-github-oss-discovery-cycle-002359`

## Counts

- Search (initial) candidates: 33
- Search (gap boost) candidates: 0
- Search (merged) candidates: 33
- Search (catalog gap boost) candidates: 0
- Search (coverage quota boost) candidates: 0
- Repo metadata fetched (*.json): 13
- Tranche repos (pre-filter): 33
- Tranche repos (post-filter): 13
...
- Effective sizing: max_total_queries=24, max_repos=120, max_queries_per_group=8
...
- Prefer-new details: removed_seen=20, kept_curated=13, curation_file=`/Users/shaansisodia/DEV/client-projects/lumelle/docs/.blackbox/oss-catalog/curation.json`, keep_statuses="adopt,poc,deepen"
