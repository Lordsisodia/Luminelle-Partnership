...
Plan: `.blackbox/.plans/2025-12-31_1952_oss-discovery-github-oss-discovery-cycle-195229`

## Counts

- Search (initial) candidates: 60
- Search (gap boost) candidates: 0
- Search (merged) candidates: 60
- Search (catalog gap boost) candidates: 0
- Search (coverage quota boost) candidates: 0
- Repo metadata fetched (*.json): 20
- Tranche repos (pre-filter): 60
- Tranche repos (post-filter): 20
...
- Effective sizing: max_total_queries=35, max_repos=75, max_queries_per_group=4
- Filters: min_stars=25, include_forks=false, include_archived=false
...
- Prefer-new details: removed_seen=40, kept_curated=7, curation_file=`/Users/shaansisodia/DEV/client-projects/lumelle/docs/.blackbox/oss-catalog/curation.json`, keep_statuses="adopt,poc,deepen"
