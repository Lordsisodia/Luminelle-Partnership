...
Plan: `.blackbox/.plans/2026-01-01_0001_oss-discovery-github-oss-discovery-cycle-000130`

## Counts

- Search (initial) candidates: 28
- Search (gap boost) candidates: 0
- Search (merged) candidates: 28
- Search (catalog gap boost) candidates: 0
- Search (coverage quota boost) candidates: 0
- Repo metadata fetched (*.json): 4
- Tranche repos (pre-filter): 28
...
- Effective sizing: max_total_queries=24, max_repos=120, max_queries_per_group=6
...
- Prefer-new details: removed_seen=24, kept_curated=4, curation_file=`/Users/shaansisodia/DEV/client-projects/lumelle/docs/.blackbox/oss-catalog/curation.json`, keep_statuses="adopt,poc,deepen"
