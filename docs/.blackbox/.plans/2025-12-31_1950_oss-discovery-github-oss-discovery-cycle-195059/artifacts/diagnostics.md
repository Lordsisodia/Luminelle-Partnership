...
Plan: `.blackbox/.plans/2025-12-31_1950_oss-discovery-github-oss-discovery-cycle-195059`

## Counts

- Search (initial) candidates: 54
- Search (gap boost) candidates: 0
- Search (merged) candidates: 54
- Search (catalog gap boost) candidates: 0
- Search (coverage quota boost) candidates: 0
- Repo metadata fetched (*.json): 22
- Tranche repos (pre-filter): 54
- Tranche repos (post-filter): 22
...
- Prefer-new details: removed_seen=32, kept_curated=6, curation_file=`/Users/shaansisodia/DEV/client-projects/lumelle/docs/.blackbox/oss-catalog/curation.json`, keep_statuses="adopt,poc,deepen"
