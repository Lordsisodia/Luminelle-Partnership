...
- Write outputs into `.blackbox/.plans/2025-12-29_0154_feature-research-synthesis-agent-zero-015445/artifacts/` (use the seeded files)
...
- `artifacts/thin-slices/README.md`
...
```bash
./docs/.blackbox/scripts/new-step.sh --plan .blackbox/.plans/2025-12-29_0154_feature-research-synthesis-agent-zero-015445 "Checkpoint: <what changed>"
```

Compact early if context grows:

```bash
./docs/.blackbox/scripts/compact-context.sh --plan .blackbox/.plans/2025-12-29_0154_feature-research-synthesis-agent-zero-015445
```
