...
# OSS Deep Audit — binwiederhier/ntfy
...
- We want **binwiederhier/ntfy** as a reusable building block so we can ship faster for merchant admins (and avoid re-building commodity primitives).
...
- Recommended default: **Inspiration-only (copy patterns, not code)**
- Notes:
...
- Repo: https://github.com/binwiederhier/ntfy
- README (raw): https://raw.githubusercontent.com/binwiederhier/ntfy/main/README.md
