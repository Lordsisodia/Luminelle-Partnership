...
# OSS Deep Audit — open-policy-agent/opa
...
- We want **open-policy-agent/opa** as a reusable building block so we can ship faster for merchant admins (and avoid re-building commodity primitives).
...
- Repo: https://github.com/open-policy-agent/opa
- README (raw): https://raw.githubusercontent.com/open-policy-agent/opa/main/README.md
