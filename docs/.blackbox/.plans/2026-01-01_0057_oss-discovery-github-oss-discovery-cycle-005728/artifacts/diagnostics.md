...
Plan: `.blackbox/.plans/2026-01-01_0057_oss-discovery-github-oss-discovery-cycle-005728`

## Counts

- Search (initial) candidates: 29
- Search (gap boost) candidates: 0
- Search (merged) candidates: 29
- Search (catalog gap boost) candidates: 0
- Search (coverage quota boost) candidates: 0
- Repo metadata fetched (*.json): 6
- Tranche repos (pre-filter): 29
...
- Prefer-new details: removed_seen=23, kept_curated=6, curation_file=`/Users/shaansisodia/DEV/client-projects/lumelle/docs/.blackbox/oss-catalog/curation.json`, keep_statuses="adopt,poc,deepen"
