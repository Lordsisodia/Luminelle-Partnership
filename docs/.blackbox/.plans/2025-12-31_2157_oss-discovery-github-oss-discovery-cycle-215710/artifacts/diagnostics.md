...
Plan: `.blackbox/.plans/2025-12-31_2157_oss-discovery-github-oss-discovery-cycle-215710`

## Counts

- Search (initial) candidates: 78
- Search (gap boost) candidates: 0
- Search (merged) candidates: 78
- Search (catalog gap boost) candidates: 0
- Search (coverage quota boost) candidates: 0
- Repo metadata fetched (*.json): 11
- Tranche repos (pre-filter): 75
- Tranche repos (post-filter): 11
...
- Prefer-new details: removed_seen=64, kept_curated=10, curation_file=`/Users/shaansisodia/DEV/client-projects/lumelle/docs/.blackbox/oss-catalog/curation.json`, keep_statuses="adopt,poc,deepen"
