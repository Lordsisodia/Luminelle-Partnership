...
Plan: `.blackbox/.plans/2025-12-31_2252_oss-discovery-github-oss-discovery-cycle-225223`

## Counts

- Search (initial) candidates: 36
- Search (gap boost) candidates: 0
- Search (merged) candidates: 36
- Search (catalog gap boost) candidates: 0
- Search (coverage quota boost) candidates: 0
- Repo metadata fetched (*.json): 13
- Tranche repos (pre-filter): 36
...
- Prefer-new details: removed_seen=23, kept_curated=13, curation_file=`/Users/shaansisodia/DEV/client-projects/lumelle/docs/.blackbox/oss-catalog/curation.json`, keep_statuses="adopt,poc,deepen"
