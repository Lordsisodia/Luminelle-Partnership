...
Plan: `.blackbox/.plans/2025-12-31_1341_oss-discovery-github-oss-discovery-cycle-134147`

## Counts

- Search (initial) candidates: 51
- Search (gap boost) candidates: 0
- Search (merged) candidates: 51
- Search (catalog gap boost) candidates: 0
- Search (coverage quota boost) candidates: 0
- Repo metadata fetched (*.json): 13
- Tranche repos (pre-filter): 51
- Tranche repos (post-filter): 14
...
- Effective sizing: max_total_queries=18, max_repos=80, max_queries_per_group=8
...
- Prefer-new details: removed_seen=37, kept_curated=2, curation_file=`/Users/shaansisodia/DEV/client-projects/lumelle/docs/.blackbox/oss-catalog/curation.json`, keep_statuses="adopt,poc,deepen"
