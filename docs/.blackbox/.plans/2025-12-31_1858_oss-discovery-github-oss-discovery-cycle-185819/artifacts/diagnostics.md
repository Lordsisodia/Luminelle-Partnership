...
Plan: `.blackbox/.plans/2025-12-31_1858_oss-discovery-github-oss-discovery-cycle-185819`

## Counts

- Search (initial) candidates: 31
- Search (gap boost) candidates: 0
- Search (merged) candidates: 31
- Search (catalog gap boost) candidates: 0
- Search (coverage quota boost) candidates: 0
- Repo metadata fetched (*.json): 7
- Tranche repos (pre-filter): 31
...
- Prefer-new details: removed_seen=24, kept_curated=7, curation_file=`/Users/shaansisodia/DEV/client-projects/lumelle/docs/.blackbox/oss-catalog/curation.json`, keep_statuses="adopt,poc,deepen"
