...
Plan: `.blackbox/.plans/2025-12-31_0944_oss-discovery-github-oss-discovery-cycle-094440`

## Counts

- Search (initial) candidates: 24
- Search (gap boost) candidates: 0
- Search (merged) candidates: 24
- Search (catalog gap boost) candidates: 0
- Search (coverage quota boost) candidates: 0
- Repo metadata fetched (*.json): 16
- Tranche repos (pre-filter): 24
...
- Prefer-new details: removed_seen=8, kept_curated=3, curation_file=`/Users/shaansisodia/DEV/client-projects/lumelle/docs/.blackbox/oss-catalog/curation.json`, keep_statuses="adopt,poc,deepen"
