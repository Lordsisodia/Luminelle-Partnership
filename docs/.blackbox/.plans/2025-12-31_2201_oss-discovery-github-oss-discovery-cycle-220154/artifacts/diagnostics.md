...
Plan: `.blackbox/.plans/2025-12-31_2201_oss-discovery-github-oss-discovery-cycle-220154`

## Counts

- Search (initial) candidates: 5
- Search (gap boost) candidates: 0
- Search (merged) candidates: 5
- Search (catalog gap boost) candidates: 0
- Search (coverage quota boost) candidates: 0
- Repo metadata fetched (*.json): 2
- Tranche repos (pre-filter): 5
...
- Filters: min_stars=25, include_forks=false, include_archived=true
...
- Prefer-new details: removed_seen=3, kept_curated=1, curation_file=`/Users/shaansisodia/DEV/client-projects/lumelle/docs/.blackbox/oss-catalog/curation.json`, keep_statuses="adopt,poc,deepen"
