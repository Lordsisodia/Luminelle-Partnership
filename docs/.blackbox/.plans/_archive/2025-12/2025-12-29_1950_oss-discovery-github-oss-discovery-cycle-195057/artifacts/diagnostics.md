...
Plan: `.blackbox/.plans/2025-12-29_1950_oss-discovery-github-oss-discovery-cycle-195057`
...
- Repo metadata fetched (*.json): 18
- Tranche repos (pre-filter): 67
- Tranche repos (post-filter): 18
...
- Effective sizing: max_total_queries=20, max_repos=75, max_queries_per_group=4
...
- Prefer-new details: removed_seen=49, kept_curated=5, curation_file=`/Users/shaansisodia/DEV/client-projects/lumelle/docs/.blackbox/oss-catalog/curation.json`, keep_statuses="adopt,poc,deepen"
