...
# ✅ Start Here: Step 04 — OSS harvesting (cool code)

Plan folder: `.blackbox/.plans/2025-12-28_2304_deep-research-feature-research-step-04-oss-harvesting-cool-code-230406`

## 🎯 Your job

- Follow the staged workflow: Align → Plan → Research → Synthesize → Report
- Write outputs into `.blackbox/.plans/2025-12-28_2304_deep-research-feature-research-step-04-oss-harvesting-cool-code-230406/artifacts/` (use the seeded files)
- Keep updates human-friendly (use comms templates)

## 📌 Prompt pack to paste into your agent session

- `docs/.blackbox/.prompts/oss-competitors-step-04-oss-harvesting.md`
...
```bash
./docs/.blackbox/scripts/new-step.sh --plan .blackbox/.plans/2025-12-28_2304_deep-research-feature-research-step-04-oss-harvesting-cool-code-230406 "Checkpoint: <what changed>"
```

Compact early if context grows:

```bash
./docs/.blackbox/scripts/compact-context.sh --plan .blackbox/.plans/2025-12-28_2304_deep-research-feature-research-step-04-oss-harvesting-cool-code-230406
```
