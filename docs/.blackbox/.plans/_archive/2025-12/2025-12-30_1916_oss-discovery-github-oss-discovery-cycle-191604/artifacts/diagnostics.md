...
Plan: `.blackbox/.plans/2025-12-30_1916_oss-discovery-github-oss-discovery-cycle-191604`

## Counts

- Search (initial) candidates: 61
- Search (gap boost) candidates: 0
- Search (merged) candidates: 61
- Search (catalog gap boost) candidates: 0
- Search (coverage quota boost) candidates: 0
- Repo metadata fetched (*.json): 50
- Tranche repos (pre-filter): 61
- Tranche repos (post-filter): 50
...
- Effective sizing: max_total_queries=26, max_repos=240, max_queries_per_group=6
...
- Prefer-new details: removed_seen=11, kept_curated=7, curation_file=`/Users/shaansisodia/DEV/client-projects/lumelle/docs/.blackbox/oss-catalog/curation.json`, keep_statuses="adopt,poc,deepen"
