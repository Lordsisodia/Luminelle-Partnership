...
- Search (initial) candidates: 18
- Search (gap boost) candidates: 0
- Search (merged) candidates: 18
- Search (catalog gap boost) candidates: 0
- Search (coverage quota boost) candidates: 0
- Repo metadata fetched (*.json): 16
- Tranche repos (pre-filter): 18
- Tranche repos (post-filter): 16
...
- Filters: min_stars=5, include_forks=false, include_archived=false
...
- Prefer-new details: removed_seen=2, kept_curated=1, curation_file=`/Users/shaansisodia/DEV/client-projects/lumelle/docs/.blackbox/oss-catalog/curation.json`, keep_statuses="adopt,poc,deepen"
