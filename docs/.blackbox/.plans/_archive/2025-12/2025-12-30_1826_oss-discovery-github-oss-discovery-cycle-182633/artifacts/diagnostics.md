...
Plan: `.blackbox/.plans/2025-12-30_1826_oss-discovery-github-oss-discovery-cycle-182633`

## Counts

- Search (initial) candidates: 35
- Search (gap boost) candidates: 0
- Search (merged) candidates: 35
- Search (catalog gap boost) candidates: 0
- Search (coverage quota boost) candidates: 0
- Repo metadata fetched (*.json): 7
- Tranche repos (pre-filter): 35
...
- Prefer-new details: removed_seen=28, kept_curated=0, curation_file=`/Users/shaansisodia/DEV/client-projects/lumelle/docs/.blackbox/oss-catalog/curation.json`, keep_statuses="adopt,poc,deepen"
