...
# OSS Discovery — Coverage quota boost (catalog only)
...
- URL: `https://api.github.com/search/repositories?q=returns%20portal%20ecommerce%20open%20source%20stars%3A%3E%3D25%20fork%3Afalse%20archived%3Afalse&sort=stars&order=desc&per_page=12`
- HTTP: `504`
- Message: `HTTP Error 504: Gateway Time-out`
- X-RateLimit-Remaining: `7`
- X-RateLimit-Reset: `1766986993`
