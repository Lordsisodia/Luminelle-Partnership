...
Plan: `.blackbox/.plans/2025-12-30_2300_oss-discovery-github-oss-discovery-cycle-230011`

## Counts

- Search (initial) candidates: 10
- Search (gap boost) candidates: 0
- Search (merged) candidates: 10
- Search (catalog gap boost) candidates: 0
- Search (coverage quota boost) candidates: 0
- Repo metadata fetched (*.json): 1
- Tranche repos (pre-filter): 10
...
- Effective sizing: max_total_queries=24, max_repos=100, max_queries_per_group=8
...
- Prefer-new details: removed_seen=9, kept_curated=1, curation_file=`/Users/shaansisodia/DEV/client-projects/lumelle/docs/.blackbox/oss-catalog/curation.json`, keep_statuses="adopt,poc,deepen"
