...
Plan: `.blackbox/.plans/2025-12-29_0607_oss-discovery-github-oss-discovery-cycle-060718`
...
- Repo tranche list: `oss/tranche-gapboost-test-repos.txt` (owner/repo)
...
./.blackbox/scripts/start-oss-discovery-cycle.sh --tranche-name tranche-gapboost-test
```
