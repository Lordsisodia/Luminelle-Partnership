...
Plan: `.blackbox/.plans/2025-12-29_2005_oss-discovery-github-oss-discovery-cycle-200553`

## Counts

- Search (initial) candidates: 119
- Search (gap boost) candidates: 0
- Search (merged) candidates: 75
- Search (catalog gap boost) candidates: 0
- Search (coverage quota boost) candidates: 13
- Repo metadata fetched (*.json): 9
- Tranche repos (pre-filter): 75
- Tranche repos (post-filter): 9
...
- Prefer-new details: removed_seen=66, kept_curated=9, curation_file=`/Users/shaansisodia/DEV/client-projects/lumelle/docs/.blackbox/oss-catalog/curation.json`, keep_statuses="adopt,poc,deepen"
...
- Catalog gap boost selection: max_tags=3, rotation_start_index=0, total_gap_tags=0, selected_gap_tags=0, selected_query_lines=0, selected_tags="", avoid_recent_tags=true, excluded_recent_tags="returns,auth,policy"
...
- Coverage quota selection: max_tags=3, rotate_tags=true, rotation_start_index=0, total_gap_tags=1, selected_gap_tags=1, selected_query_lines=5, selected_tags="policy", avoid_recent_tags=true, excluded_recent_tags="returns,auth,policy", excluded_tags="returns,auth,policy"
