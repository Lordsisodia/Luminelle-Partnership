...
Plan: `.blackbox/.plans/2025-12-30_1759_oss-discovery-github-oss-discovery-cycle-175908`

## Counts

- Search (initial) candidates: 14
- Search (gap boost) candidates: 0
- Search (merged) candidates: 14
- Search (catalog gap boost) candidates: 0
- Search (coverage quota boost) candidates: 0
- Repo metadata fetched (*.json): 3
- Tranche repos (pre-filter): 14
...
- Effective sizing: max_total_queries=22, max_repos=140, max_queries_per_group=4
...
- Prefer-new details: removed_seen=11, kept_curated=2, curation_file=`/Users/shaansisodia/DEV/client-projects/lumelle/docs/.blackbox/oss-catalog/curation.json`, keep_statuses="adopt,poc,deepen"
