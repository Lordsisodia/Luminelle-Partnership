...
Plan: `.blackbox/.plans/2025-12-30_2230_oss-discovery-github-oss-discovery-cycle-223036`

## Counts

- Search (initial) candidates: 56
- Search (gap boost) candidates: 0
- Search (merged) candidates: 56
- Search (catalog gap boost) candidates: 0
- Search (coverage quota boost) candidates: 0
- Repo metadata fetched (*.json): 15
- Tranche repos (pre-filter): 40
- Tranche repos (post-filter): 15

## Settings snapshot

- Token used: yes
- Auto-tune: enabled=false (prev_failures_no_token=0, threshold=2, active=false, applied_max_total_queries=false, applied_max_repos=false)
...
- Effective sizing: max_total_queries=24, max_repos=40, max_queries_per_group=4
...
- Prefer-new details: removed_seen=25, kept_curated=4, curation_file=`/Users/shaansisodia/DEV/client-projects/lumelle/docs/.blackbox/oss-catalog/curation.json`, keep_statuses="adopt,poc,deepen"
