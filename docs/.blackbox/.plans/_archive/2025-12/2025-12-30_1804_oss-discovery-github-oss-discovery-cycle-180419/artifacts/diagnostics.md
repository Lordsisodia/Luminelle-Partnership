...
Plan: `.blackbox/.plans/2025-12-30_1804_oss-discovery-github-oss-discovery-cycle-180419`

## Counts

- Search (initial) candidates: 46
- Search (gap boost) candidates: 0
- Search (merged) candidates: 46
- Search (catalog gap boost) candidates: 0
- Search (coverage quota boost) candidates: 0
- Repo metadata fetched (*.json): 10
- Tranche repos (pre-filter): 46
- Tranche repos (post-filter): 10
...
- Effective sizing: max_total_queries=28, max_repos=160, max_queries_per_group=4
...
- Prefer-new details: removed_seen=36, kept_curated=6, curation_file=`/Users/shaansisodia/DEV/client-projects/lumelle/docs/.blackbox/oss-catalog/curation.json`, keep_statuses="adopt,poc,deepen"
