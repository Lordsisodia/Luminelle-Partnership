...
Plan: `.blackbox/.plans/2025-12-29_2002_oss-discovery-github-oss-discovery-cycle-200258`

## Counts

- Search (initial) candidates: 117
- Search (gap boost) candidates: 0
- Search (merged) candidates: 75
- Search (catalog gap boost) candidates: 0
- Search (coverage quota boost) candidates: 30
- Repo metadata fetched (*.json): 12
- Tranche repos (pre-filter): 75
- Tranche repos (post-filter): 12
...
- Prefer-new details: removed_seen=63, kept_curated=9, curation_file=`/Users/shaansisodia/DEV/client-projects/lumelle/docs/.blackbox/oss-catalog/curation.json`, keep_statuses="adopt,poc,deepen"
...
- Catalog gap boost selection: max_tags=3, rotation_start_index=0, total_gap_tags=0, selected_gap_tags=0, selected_query_lines=0, selected_tags="", avoid_recent_tags=true, excluded_recent_tags="auth,returns,policy"
- Catalog gap boost details: blocked=false, blocked_reason="", error_http_status=""
- Coverage quota boost: enabled=true, applied=true, min_count_per_tag=2, max_total_queries=6, min_stars_relaxed=25, repo_delta=3
- Coverage quota selection: max_tags=3, rotate_tags=true, rotation_start_index=1, total_gap_tags=2, selected_gap_tags=2, selected_query_lines=10, selected_tags="auth,policy", avoid_recent_tags=true, excluded_recent_tags="auth,returns,policy", excluded_tags="auth,returns,policy"
