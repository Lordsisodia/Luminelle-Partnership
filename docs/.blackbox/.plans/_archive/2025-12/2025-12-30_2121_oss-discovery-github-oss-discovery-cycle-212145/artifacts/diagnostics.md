...
Plan: `.blackbox/.plans/2025-12-30_2121_oss-discovery-github-oss-discovery-cycle-212145`

## Counts

- Search (initial) candidates: 106
- Search (gap boost) candidates: 0
- Search (merged) candidates: 106
- Search (catalog gap boost) candidates: 0
- Search (coverage quota boost) candidates: 0
- Repo metadata fetched (*.json): 74
- Tranche repos (pre-filter): 75
- Tranche repos (post-filter): 74
...
- Prefer-new details: removed_seen=1, kept_curated=2, curation_file=`/Users/shaansisodia/DEV/client-projects/lumelle/docs/.blackbox/oss-catalog/curation.json`, keep_statuses="adopt,poc,deepen"
