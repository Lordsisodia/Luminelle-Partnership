...
Plan folder: `.blackbox/.plans/2025-12-28_2252_deep-research-feature-research-step-04-oss-harvesting-cool-code-225232`

## 🎯 Your job

- Follow the staged workflow: Align → Plan → Research → Synthesize → Report
- Write outputs into `.blackbox/.plans/2025-12-28_2252_deep-research-feature-research-step-04-oss-harvesting-cool-code-225232/artifacts/` (use the seeded files)
...
```bash
./docs/.blackbox/scripts/new-step.sh --plan .blackbox/.plans/2025-12-28_2252_deep-research-feature-research-step-04-oss-harvesting-cool-code-225232 "Checkpoint: <what changed>"
```

Compact early if context grows:

```bash
./docs/.blackbox/scripts/compact-context.sh --plan .blackbox/.plans/2025-12-28_2252_deep-research-feature-research-step-04-oss-harvesting-cool-code-225232
```
