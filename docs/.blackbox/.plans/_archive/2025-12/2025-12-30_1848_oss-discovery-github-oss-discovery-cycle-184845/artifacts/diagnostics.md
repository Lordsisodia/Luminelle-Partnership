...
Plan: `.blackbox/.plans/2025-12-30_1848_oss-discovery-github-oss-discovery-cycle-184845`
...
- Repo metadata fetched (*.json): 26
- Tranche repos (pre-filter): 60
- Tranche repos (post-filter): 26
...
- Prefer-new details: removed_seen=34, kept_curated=7, curation_file=`/Users/shaansisodia/DEV/client-projects/lumelle/docs/.blackbox/oss-catalog/curation.json`, keep_statuses="adopt,poc,deepen"
