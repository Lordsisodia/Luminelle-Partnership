...
Plan: `.blackbox/.plans/2025-12-29_1957_oss-discovery-github-oss-discovery-cycle-195748`

## Counts

- Search (initial) candidates: 34
- Search (gap boost) candidates: 0
- Search (merged) candidates: 34
- Search (catalog gap boost) candidates: 0
- Search (coverage quota boost) candidates: 0
- Repo metadata fetched (*.json): 28
- Tranche repos (pre-filter): 34
...
- Effective sizing: max_total_queries=24, max_repos=90, max_queries_per_group=4
...
- Prefer-new details: removed_seen=6, kept_curated=4, curation_file=`/Users/shaansisodia/DEV/client-projects/lumelle/docs/.blackbox/oss-catalog/curation.json`, keep_statuses="adopt,poc,deepen"
- Recent gap-tag cache: window=10, recent_tags="auth,returns,policy"
