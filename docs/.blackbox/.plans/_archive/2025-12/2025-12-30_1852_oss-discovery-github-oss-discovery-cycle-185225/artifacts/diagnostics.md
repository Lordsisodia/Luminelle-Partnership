...
Plan: `.blackbox/.plans/2025-12-30_1852_oss-discovery-github-oss-discovery-cycle-185225`

## Counts

- Search (initial) candidates: 39
- Search (gap boost) candidates: 0
- Search (merged) candidates: 39
- Search (catalog gap boost) candidates: 0
- Search (coverage quota boost) candidates: 0
- Repo metadata fetched (*.json): 10
- Tranche repos (pre-filter): 39
...
- Prefer-new details: removed_seen=29, kept_curated=7, curation_file=`/Users/shaansisodia/DEV/client-projects/lumelle/docs/.blackbox/oss-catalog/curation.json`, keep_statuses="adopt,poc,deepen"
