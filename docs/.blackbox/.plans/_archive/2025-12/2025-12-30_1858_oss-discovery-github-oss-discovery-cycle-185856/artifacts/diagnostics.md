...
Plan: `.blackbox/.plans/2025-12-30_1858_oss-discovery-github-oss-discovery-cycle-185856`

## Counts

- Search (initial) candidates: 58
- Search (gap boost) candidates: 0
- Search (merged) candidates: 58
- Search (catalog gap boost) candidates: 0
- Search (coverage quota boost) candidates: 0
- Repo metadata fetched (*.json): 32
- Tranche repos (pre-filter): 58
- Tranche repos (post-filter): 32
...
- Prefer-new details: removed_seen=26, kept_curated=1, curation_file=`/Users/shaansisodia/DEV/client-projects/lumelle/docs/.blackbox/oss-catalog/curation.json`, keep_statuses="adopt,poc,deepen"
