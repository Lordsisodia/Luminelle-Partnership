...
Plan: `.blackbox/.plans/2025-12-30_1920_oss-discovery-github-oss-discovery-cycle-192022`

## Counts

- Search (initial) candidates: 20
- Search (gap boost) candidates: 0
- Search (merged) candidates: 20
- Search (catalog gap boost) candidates: 0
- Search (coverage quota boost) candidates: 0
- Repo metadata fetched (*.json): 6
- Tranche repos (pre-filter): 20
...
- Prefer-new details: removed_seen=14, kept_curated=6, curation_file=`/Users/shaansisodia/DEV/client-projects/lumelle/docs/.blackbox/oss-catalog/curation.json`, keep_statuses="adopt,poc,deepen"
