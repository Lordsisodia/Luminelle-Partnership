...
## 1) QuantumLeaps/Super-Simple-Tasker

- Repo: https://github.com/QuantumLeaps/Super-Simple-Tasker
- Stars: 239
- License: ✅ MIT
- Language: C
- Updated: 2025-12-27T06:32:27Z
- Description: Event-driven, preemptive, priority-based, hardware RTOS for ARM Cortex-M.
...
- Repo: https://github.com/ROCm/iris
- Stars: 143
- License: ✅ MIT
- Language: Python
- Updated: 2025-12-30T10:51:04Z
- Description: AMD RAD's multi-GPU Triton-based framework for seamless multi-GPU programming
...
## 3) solidusio-contrib/solidus_virtual_gift_card

- Repo: https://github.com/solidusio-contrib/solidus_virtual_gift_card
- Stars: 32
- License: ✅ BSD-3-Clause
- Language: Ruby
- Updated: 2025-05-23T13:00:19Z
- Description: Virtual gift cards for your Solidus store.
...
## 4) auroraextensions/simplereturns

- Repo: https://github.com/auroraextensions/simplereturns
- Stars: 22
- License: ✅ MIT
- Language: PHP
- Updated: 2025-05-28T03:07:50Z
- Description: Self-service RMA for Magento.
...
- Repo: https://github.com/kxtzownsu/KVS
- Stars: 19
- License: 🧨 AGPL-3.0
- Language: C
- Updated: 2025-12-14T00:02:02Z
- Description: shitty C project that switches your kernver (ChromeOS, RMA Shim only)
...
## 7) ehsanking/xui-sales-associate

- Repo: https://github.com/ehsanking/xui-sales-associate
- Stars: 13
- License: ⚠️ NOASSERTION
- Language: PHP
- Updated: 2025-12-25T13:38:57Z
- Description: Automate creating/renewing Xray accounts on a **3x-ui** panel straight from **WooCommerce**. The plugin calls a secure **Cloudflare Worker**; the Worker logs into 3x-ui, adds/upserts the client, and returns subscription details to show in **My Account**.
