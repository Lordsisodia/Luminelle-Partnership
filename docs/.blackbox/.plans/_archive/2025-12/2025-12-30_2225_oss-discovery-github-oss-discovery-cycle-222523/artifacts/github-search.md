...
owner: agent-zero
generated_at_utc: 2025-12-30T15:25:51Z
total_unique_repos: 7
min_stars: 10
include_forks: false
...
- topic:rma stars:>=10 fork:false
- topic:return-portal stars:>=10 fork:false
- topic:reverse-logistics stars:>=10 fork:false
- topic:store-credit stars:>=10 fork:false
- "returns portal" shopify stars:>=10 fork:false
- "return label" shopify stars:>=10 fork:false
- "exchange" shopify "store credit" stars:>=10 fork:false
- "store credit" shopify returns stars:>=10 fork:false
- "rma number" returns stars:>=10 fork:false
- "return reason" rma stars:>=10 fork:false
- "return received" restock stars:>=10 fork:false
- "return portal" ecommerce stars:>=10 fork:false
- "magento" rma stars:>=10 fork:false
- "woocommerce" returns stars:>=10 fork:false
- "spree" rma stars:>=10 fork:false
- "saleor" returns stars:>=10 fork:false

## ⚡ Top 25 “<1 week integration” candidates (heuristic)

| Rank | Repo | Stars | Lang | License | Bucket | Why it’s here |
|---:|---|---:|---|---|---|---|
| 1 | ROCm/iris — https://github.com/ROCm/iris | 143 | Python | MIT | safe | score=7 (lang+recency+stars+license) |
| 2 | QuantumLeaps/Super-Simple-Tasker — https://github.com/QuantumLeaps/Super-Simple-Tasker | 239 | C | MIT | safe | score=6 (lang+recency+stars+license) |
| 3 | glennneiger/Magento-2-affiliate-pro — https://github.com/glennneiger/Magento-2-affiliate-pro | 21 | N/A | UNKNOWN | verify | score=5 (lang+recency+stars+license) |
| 4 | ehsanking/xui-sales-associate — https://github.com/ehsanking/xui-sales-associate | 13 | PHP | NOASSERTION | verify | score=5 (lang+recency+stars+license) |
| 5 | solidusio-contrib/solidus_virtual_gift_card — https://github.com/solidusio-contrib/solidus_virtual_gift_card | 32 | Ruby | BSD-3-Clause | safe | score=4 (lang+recency+stars+license) |
| 6 | auroraextensions/simplereturns — https://github.com/auroraextensions/simplereturns | 22 | PHP | MIT | safe | score=4 (lang+recency+stars+license) |
| 7 | kxtzownsu/KVS — https://github.com/kxtzownsu/KVS | 19 | C | AGPL-3.0 | flagged | score=4 (lang+recency+stars+license) |

## 📚 Topic signals (no topic:ecommerce; too strict in practice) (top by stars)

| Repo | Stars | Lang | License | Bucket | Updated | Description |
|---|---:|---|---|---|---|---|
| QuantumLeaps/Super-Simple-Tasker — https://github.com/QuantumLeaps/Super-Simple-Tasker | 239 | C | MIT | safe | 2025-12-27T06:32:27Z | Event-driven, preemptive, priority-based, hardware RTOS for ARM Cortex-M. |
| ROCm/iris — https://github.com/ROCm/iris | 143 | Python | MIT | safe | 2025-12-30T10:51:04Z | AMD RAD's multi-GPU Triton-based framework for seamless multi-GPU programming |
...
| kxtzownsu/KVS — https://github.com/kxtzownsu/KVS | 19 | C | AGPL-3.0 | flagged | 2025-12-14T00:02:02Z | shitty C project that switches your kernver (ChromeOS, RMA Shim only) |
