...
owner: agent-zero
generated_at_utc: 2025-12-30T15:49:33Z
total_unique_repos: 4
min_stars: 10
include_forks: true
include_archived: true
excluded_results_count: 2
exclude_keywords: template, starter, boilerplate, example, demo, awesome
exclude_regex: \b(portfolio|resume|curriculum|cv|homework|assignment|course|semester|leetcode|tutorial|cheatsheet|whitepaper|paper|book|chromeos|chromebook|gpu|rocm|triton|rtos|cortex)\b
---
...
- topic:return-portal stars:>=10
- topic:reverse-logistics stars:>=10
- topic:store-credit stars:>=10
- "returns portal" shopify stars:>=10
- "return label" shopify stars:>=10
- "exchange" shopify "store credit" stars:>=10
- "store credit" shopify returns stars:>=10
- "store credit" returns ecommerce stars:>=10
- "return label" ecommerce stars:>=10
- "return merchandise authorization" ecommerce stars:>=10
- "rma" ecommerce returns stars:>=10
- "saleor" returns stars:>=10
- "magento2" rma stars:>=10
- "magento 2" rma stars:>=10
- "woocommerce" returns plugin stars:>=10
