...
| --- | --- | --- | --- | --- | --- | --- |
| 1 | … | … | … | … | build / integrate / buy | `artifacts/` |
| 2 | … | … | … | … | build / integrate / buy | `artifacts/` |
| 3 | … | … | … | … | build / integrate / buy | `artifacts/` |
| 4 | … | … | … | … | build / integrate / buy | `artifacts/` |
| 5 | … | … | … | … | build / integrate / buy | `artifacts/` |
| 6 | … | … | … | … | build / integrate / buy | `artifacts/` |
| 7 | … | … | … | … | build / integrate / buy | `artifacts/` |
| 8 | … | … | … | … | build / integrate / buy | `artifacts/` |
| 9 | … | … | … | … | build / integrate / buy | `artifacts/` |
| 10 | … | … | … | … | build / integrate / buy | `artifacts/` |
...
```bash
python3 .blackbox/scripts/research/generate_evidence_index.py --synth-plan .blackbox/.plans/2025-12-28_2224_feature-research-synthesis-agent-zero
```
