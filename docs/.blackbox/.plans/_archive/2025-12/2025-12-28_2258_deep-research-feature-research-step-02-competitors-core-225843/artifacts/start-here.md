...
Plan folder: `.blackbox/.plans/2025-12-28_2258_deep-research-feature-research-step-02-competitors-core-225843`

## 🎯 Your job

- Follow the staged workflow: Align → Plan → Research → Synthesize → Report
- Write outputs into `.blackbox/.plans/2025-12-28_2258_deep-research-feature-research-step-02-competitors-core-225843/artifacts/` (use the seeded files)
...
```bash
./docs/.blackbox/scripts/new-step.sh --plan .blackbox/.plans/2025-12-28_2258_deep-research-feature-research-step-02-competitors-core-225843 "Checkpoint: <what changed>"
```

Compact early if context grows:

```bash
./docs/.blackbox/scripts/compact-context.sh --plan .blackbox/.plans/2025-12-28_2258_deep-research-feature-research-step-02-competitors-core-225843
```
