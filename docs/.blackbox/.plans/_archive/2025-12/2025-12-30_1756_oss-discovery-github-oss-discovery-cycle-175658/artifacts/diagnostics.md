...
Plan: `.blackbox/.plans/2025-12-30_1756_oss-discovery-github-oss-discovery-cycle-175658`

## Counts

- Search (initial) candidates: 17
- Search (gap boost) candidates: 0
- Search (merged) candidates: 17
- Search (catalog gap boost) candidates: 0
- Search (coverage quota boost) candidates: 0
- Repo metadata fetched (*.json): 4
- Tranche repos (pre-filter): 17
...
- Effective sizing: max_total_queries=24, max_repos=120, max_queries_per_group=4
...
- Prefer-new details: removed_seen=13, kept_curated=2, curation_file=`/Users/shaansisodia/DEV/client-projects/lumelle/docs/.blackbox/oss-catalog/curation.json`, keep_statuses="adopt,poc,deepen"
