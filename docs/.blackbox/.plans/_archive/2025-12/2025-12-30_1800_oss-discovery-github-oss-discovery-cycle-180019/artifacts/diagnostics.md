...
Plan: `.blackbox/.plans/2025-12-30_1800_oss-discovery-github-oss-discovery-cycle-180019`

## Counts

- Search (initial) candidates: 7
- Search (gap boost) candidates: 0
- Search (merged) candidates: 7
- Search (catalog gap boost) candidates: 0
- Search (coverage quota boost) candidates: 0
- Repo metadata fetched (*.json): 2
- Tranche repos (pre-filter): 7
...
- Effective sizing: max_total_queries=26, max_repos=120, max_queries_per_group=4
...
- Prefer-new details: removed_seen=5, kept_curated=2, curation_file=`/Users/shaansisodia/DEV/client-projects/lumelle/docs/.blackbox/oss-catalog/curation.json`, keep_statuses="adopt,poc,deepen"
