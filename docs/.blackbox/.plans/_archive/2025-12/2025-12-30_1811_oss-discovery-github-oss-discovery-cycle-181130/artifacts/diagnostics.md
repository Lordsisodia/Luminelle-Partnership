...
Plan: `.blackbox/.plans/2025-12-30_1811_oss-discovery-github-oss-discovery-cycle-181130`

## Counts

- Search (initial) candidates: 26
- Search (gap boost) candidates: 0
- Search (merged) candidates: 26
- Search (catalog gap boost) candidates: 0
- Search (coverage quota boost) candidates: 0
- Repo metadata fetched (*.json): 6
- Tranche repos (pre-filter): 26
...
- Rotation: enabled=false, state_file=`/Users/shaansisodia/DEV/client-projects/lumelle/docs/.blackbox/.local/oss-discovery-state.json`
...
- Effective sizing: max_total_queries=24, max_repos=160, max_queries_per_group=6
- Filters: min_stars=20, include_forks=false, include_archived=false
...
- Prefer-new details: removed_seen=20, kept_curated=6, curation_file=`/Users/shaansisodia/DEV/client-projects/lumelle/docs/.blackbox/oss-catalog/curation.json`, keep_statuses="adopt,poc,deepen"
