...
Plan: `.blackbox/.plans/2025-12-29_0602_oss-discovery-github-oss-discovery-cycle-060242`
...
- Repo tranche list: `oss/tranche-rot-test-repos.txt` (owner/repo)
...
./.blackbox/scripts/start-oss-discovery-cycle.sh --tranche-name tranche-rot-test
```
