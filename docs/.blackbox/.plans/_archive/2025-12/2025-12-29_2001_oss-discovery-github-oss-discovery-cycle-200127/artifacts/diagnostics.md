...
Plan: `.blackbox/.plans/2025-12-29_2001_oss-discovery-github-oss-discovery-cycle-200127`

## Counts

- Search (initial) candidates: 30
- Search (gap boost) candidates: 0
- Search (merged) candidates: 30
- Search (catalog gap boost) candidates: 0
- Search (coverage quota boost) candidates: 0
- Repo metadata fetched (*.json): 6
- Tranche repos (pre-filter): 30
...
- Prefer-new details: removed_seen=24, kept_curated=6, curation_file=`/Users/shaansisodia/DEV/client-projects/lumelle/docs/.blackbox/oss-catalog/curation.json`, keep_statuses="adopt,poc,deepen"
