...
Plan: `.blackbox/.plans/2025-12-30_1855_oss-discovery-github-oss-discovery-cycle-185529`

## Counts

- Search (initial) candidates: 50
- Search (gap boost) candidates: 0
- Search (merged) candidates: 50
- Search (catalog gap boost) candidates: 0
- Search (coverage quota boost) candidates: 0
- Repo metadata fetched (*.json): 19
- Tranche repos (pre-filter): 50
...
- Prefer-new details: removed_seen=31, kept_curated=4, curation_file=`/Users/shaansisodia/DEV/client-projects/lumelle/docs/.blackbox/oss-catalog/curation.json`, keep_statuses="adopt,poc,deepen"
