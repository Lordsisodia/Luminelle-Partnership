...
Plan: `.blackbox/.plans/2025-12-30_1807_oss-discovery-github-oss-discovery-cycle-180709`

## Counts

- Search (initial) candidates: 1
- Search (gap boost) candidates: 0
- Search (merged) candidates: 1
- Search (catalog gap boost) candidates: 0
- Search (coverage quota boost) candidates: 0
- Repo metadata fetched (*.json): 1
- Tranche repos (pre-filter): 1
...
- Effective sizing: max_total_queries=18, max_repos=120, max_queries_per_group=4
...
- Prefer-new details: removed_seen=0, kept_curated=1, curation_file=`/Users/shaansisodia/DEV/client-projects/lumelle/docs/.blackbox/oss-catalog/curation.json`, keep_statuses="adopt,poc,deepen"
