...
Plan: `.blackbox/.plans/2025-12-31_0628_oss-discovery-github-oss-discovery-cycle-062815`

## Counts

- Search (initial) candidates: 2
- Search (gap boost) candidates: 0
- Search (merged) candidates: 2
- Search (catalog gap boost) candidates: 0
- Search (coverage quota boost) candidates: 0
- Repo metadata fetched (*.json): 1
- Tranche repos (pre-filter): 2
...
- Effective sizing: max_total_queries=30, max_repos=120, max_queries_per_group=10
- Filters: min_stars=5, include_forks=false, include_archived=true
...
- Prefer-new details: removed_seen=1, kept_curated=1, curation_file=`/Users/shaansisodia/DEV/client-projects/lumelle/docs/.blackbox/oss-catalog/curation.json`, keep_statuses="adopt,poc,deepen"
