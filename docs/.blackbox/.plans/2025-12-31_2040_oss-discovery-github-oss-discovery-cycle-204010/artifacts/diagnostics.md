...
Plan: `.blackbox/.plans/2025-12-31_2040_oss-discovery-github-oss-discovery-cycle-204010`

## Counts

- Search (initial) candidates: 62
- Search (gap boost) candidates: 0
- Search (merged) candidates: 62
- Search (catalog gap boost) candidates: 0
- Search (coverage quota boost) candidates: 0
- Repo metadata fetched (*.json): 8
- Tranche repos (pre-filter): 62
...
- Effective sizing: max_total_queries=30, max_repos=75, max_queries_per_group=4
...
- Prefer-new details: removed_seen=54, kept_curated=4, curation_file=`/Users/shaansisodia/DEV/client-projects/lumelle/docs/.blackbox/oss-catalog/curation.json`, keep_statuses="adopt,poc,deepen"
