...
Plan: `.blackbox/.plans/2025-12-31_2107_oss-discovery-github-oss-discovery-cycle-210736`

## Counts

- Search (initial) candidates: 86
- Search (gap boost) candidates: 0
- Search (merged) candidates: 86
- Search (catalog gap boost) candidates: 0
- Search (coverage quota boost) candidates: 0
- Repo metadata fetched (*.json): 17
- Tranche repos (pre-filter): 75
- Tranche repos (post-filter): 17
...
- Prefer-new details: removed_seen=58, kept_curated=14, curation_file=`/Users/shaansisodia/DEV/client-projects/lumelle/docs/.blackbox/oss-catalog/curation.json`, keep_statuses="adopt,poc,deepen"
