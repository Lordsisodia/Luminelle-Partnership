...
Plan: `.blackbox/.plans/2025-12-31_1239_oss-discovery-github-oss-discovery-cycle-123915`

## Counts

- Search (initial) candidates: 67
- Search (gap boost) candidates: 0
- Search (merged) candidates: 67
- Search (catalog gap boost) candidates: 0
- Search (coverage quota boost) candidates: 0
- Repo metadata fetched (*.json): 19
- Tranche repos (pre-filter): 67
- Tranche repos (post-filter): 19
...
- Effective sizing: max_total_queries=30, max_repos=75, max_queries_per_group=6
...
- Prefer-new details: removed_seen=48, kept_curated=12, curation_file=`/Users/shaansisodia/DEV/client-projects/lumelle/docs/.blackbox/oss-catalog/curation.json`, keep_statuses="adopt,poc,deepen"
- Recent gap-tag cache: window=10, recent_tags="auth,policy,shipping,support,workflows,admin,cms,observability,commerce,analytics"
...
- Coverage quota selection: max_tags=3, rotate_tags=true, rotation_start_index=7, total_gap_tags=12, selected_gap_tags=3, selected_query_lines=15, selected_tags="observability,commerce,analytics", avoid_recent_tags=true, excluded_recent_tags="returns,auth,policy,shipping,support,workflows,admin,cms", excluded_tags="returns,auth,policy,shipping,support,workflows,admin,cms"
