...
- If you want “just markdown files” (no `.env`), store secrets only in:
  - `docs/.blackbox/.local/*.md` (gitignored)
...
## Tooling
- Local (no keys): `docs/.blackbox/scripts/notify-local.sh`
- Pushover: `docs/.blackbox/scripts/notify-pushover.sh`
- Pushcut: `docs/.blackbox/scripts/notify-pushcut.sh`
