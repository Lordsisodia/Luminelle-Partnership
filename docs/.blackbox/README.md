...
- `.timeline/` — append-only activity feed (see `.timeline/README.md`)
...
## 📚 Reusable assets
- `.skills/` — repeatable playbooks (how to work)
...
```bash
# Create a new timestamped plan folder (copies from `.plans/_template/`)
