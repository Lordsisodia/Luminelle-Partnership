...
## Outputs (artifacts)
1. A **plan folder** saved in `.blackbox/.plans/`
...
Plan folder location: `.blackbox/.plans/`
...
Create a new plan folder in `.blackbox/.plans/` using the conventions in `.blackbox/.plans/README.md`.
