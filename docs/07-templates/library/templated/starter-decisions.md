...
See `docs/07-templates/library/templated/customer-sync.md` for details and missing pieces.
...
- See `docs/07-templates/library/templated/supabase-topology.md` for the tradeoffs.
