...
See `docs/07-templates/library/templated/template-hardening-backlog.md` for the full list.
...
Start here:
- `docs/07-templates/library/templated/new-client-intake.md`
- `docs/07-templates/library/templated/new-client-setup-steps.md`
- `docs/07-templates/library/templated/clientization-inventory.md`
