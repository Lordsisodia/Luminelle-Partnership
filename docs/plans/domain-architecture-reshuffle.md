...
- Aliases noted in `docs/domains-README.md`: `@landing`, `@blog`, `@shop` (products/cart/checkout/shared), `@account`, `@auth`, `@admin`, `@shopify`, plus `@/lib/*`.
...
6) Refresh docs: `docs/domains-README.md`, `src/domains/README.md`, and add a short “How to add a feature” for `client`.
...
21) Clean docs: update `src/domains/README.md`, `docs/domains-README.md`, and add per-domain “how to add a feature” notes reflecting new paths.
...
- 2025-12-20 (Step 17 cont.): Auth logic moved into platform.
  ...
  - Typecheck after move: ✅ (`npm run typecheck -- --noEmit`).
- 2025-12-20 (Step 17 cont.2): Shopify client moved to platform/commerce.
  ...
  - Updated imports to `@platform/commerce/shopify/*` (cart logic, cart provider, sections).
  - Typecheck after move: ✅ (`npm run typecheck -- --noEmit`).
