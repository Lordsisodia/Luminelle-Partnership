# Client Feedback — 2026-01-07

Date: **January 7, 2026**

## Summary

- The client reported that **multi-buy discounts are not working at checkout**.
- The client requested **new discount tiers** for multi-purchases:
  - **5% for 2**
  - **10% for 3**
  - **15% for 4**
  - **Delete the 5th tier**
...
- This feedback is being tracked as an issue so we can run multiple agents:
  - Research + root-cause investigation
  - Proposed solution options for a later “implementation agent”

## Linked issues

- `docs/06-quality/feedback/ui-issue-tracker/ui-issues/issue-181.md`
- `docs/06-quality/feedback/ui-issue-tracker/done-issues/issue-182.md`
