...
Source audit: `docs/06-quality/reviews/app-ui-review-2025-12-26.md` — issue `77`
...
Audit (issue 77): `docs/06-quality/reviews/app-ui-review-2025-12-26.md` — “`LazyVisible` assumes `IntersectionObserver` exists”.
...
- Audit: `docs/06-quality/reviews/app-ui-review-2025-12-26.md` (issue 77)
- Code refs:
