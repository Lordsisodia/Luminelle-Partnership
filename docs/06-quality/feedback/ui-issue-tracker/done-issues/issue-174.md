...
Source audit: `docs/06-quality/reviews/app-ui-review-2025-12-26.md` — issue `174`
...
Audit (issue 174): `docs/06-quality/reviews/app-ui-review-2025-12-26.md` — “Public header shows two “Account” links on desktop (redundant + wastes header space)”.
...
- Audit: `docs/06-quality/reviews/app-ui-review-2025-12-26.md` (issue 174)
- Code refs:
