...
Source audit: `docs/06-quality/reviews/app-ui-review-2025-12-26.md` — issue `36`
...
Audit (issue 36): `docs/06-quality/reviews/app-ui-review-2025-12-26.md` — “Two different `cdnUrl` helpers exist (inconsistent asset loading + CDN-bypass mismatch)”.
...
- Audit: `docs/06-quality/reviews/app-ui-review-2025-12-26.md` (issue 36)
- Code refs:
  - `src/lib/utils/cdn.ts` (canonical implementation)
