...
Source audit: `docs/06-quality/reviews/app-ui-review-2025-12-26.md` — issue `12`
...
- [x] Link to the audit issue and copy the key claim.
  - Audit issue `12` (`docs/06-quality/reviews/app-ui-review-2025-12-26.md`): the drawer uses a random “people checking out now” number as social proof/urgency.
