...
Source audit: `docs/06-quality/reviews/app-ui-review-2025-12-26.md` — issue `169`
...
Audit (issue 169): `docs/06-quality/reviews/app-ui-review-2025-12-26.md` — “Admin Products editor can lose unsaved changes with no warning when switching products”.
...
- Audit: `docs/06-quality/reviews/app-ui-review-2025-12-26.md` (issue 169)
- Code refs:
