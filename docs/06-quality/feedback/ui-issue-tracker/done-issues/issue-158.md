...
Source audit: `docs/06-quality/reviews/app-ui-review-2025-12-26.md` — issue `158`
...
Audit (issue 158): `docs/06-quality/reviews/app-ui-review-2025-12-26.md` — “App sets a persistent `lumelle_anon_id` cookie with no consent UI”.
...
- Audit: `docs/06-quality/reviews/app-ui-review-2025-12-26.md` (issue 158)
- Code refs:
