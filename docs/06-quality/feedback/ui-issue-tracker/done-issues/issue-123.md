...
Source audit: `docs/06-quality/reviews/app-ui-review-2025-12-26.md` — issue `123`
...
Audit (issue 123): `docs/06-quality/reviews/app-ui-review-2025-12-26.md` — “Creator ‘Leaderboard’ claims it updates daily, but it’s hard-coded static data”.
...
- Audit: `docs/06-quality/reviews/app-ui-review-2025-12-26.md` (issue 123)
- Code refs:
