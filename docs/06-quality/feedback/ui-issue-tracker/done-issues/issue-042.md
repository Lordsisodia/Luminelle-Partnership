...
Source audit: `docs/06-quality/reviews/app-ui-review-2025-12-26.md` — issue `42`
...
Audit (issue 42): `docs/06-quality/reviews/app-ui-review-2025-12-26.md` — “Two different header components exist, and they disagree on core navigation patterns”.
...
- Audit: `docs/06-quality/reviews/app-ui-review-2025-12-26.md` (issue 42)
- Code refs:
