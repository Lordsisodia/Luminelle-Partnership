...
Source audit: `docs/06-quality/reviews/app-ui-review-2025-12-26.md` — issue `{ID}`
Tracker: `docs/06-quality/feedback/ui-issue-tracker/ui-issue-tracker.md`

## Metadata

- Status: `UNTRIAGED`
- Area: `TBD` (Admin / Client / Blog / Platform / Creator)
- Impact (1–5): `TBD`
- Reach (1–5): `TBD`
- Effort (1–5): `TBD`
- Confidence (1–3): `TBD`
...
- Tracker row updated (status + priority if changed)
- Worklog filled with:
  - evidence + repro
  - chosen option + rationale
  - plan + acceptance criteria
  - validation notes + “how to verify”
- If fixed: code change references (paths) and a short summary
