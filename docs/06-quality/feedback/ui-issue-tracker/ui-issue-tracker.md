...
| 183 | Client | Mobile account + footer has weird padding / horizontal scroll (should not scroll sideways) | 0 | IN_PROGRESS | [issue-183](ui-issues/issue-183.md) |
...
| 183 | Client | Mobile account + footer has weird padding / horizontal scroll (should not scroll sideways) | 3 | 5 | 2 | 2 | 0 | IN_PROGRESS | [issue-183](ui-issues/issue-183.md) |
