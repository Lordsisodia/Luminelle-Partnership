...
| 185 | Client | Entire site allows horizontal scrolling on mobile (layout should be flush + centered) | 38 | VALIDATING | [issue-185](ui-issues/issue-185.md) |
...
| 185 | Client | Entire site allows horizontal scrolling on mobile (layout should be flush + centered) | 4 | 5 | 2 | 2 | 38 | VALIDATING | [issue-185](ui-issues/issue-185.md) |
