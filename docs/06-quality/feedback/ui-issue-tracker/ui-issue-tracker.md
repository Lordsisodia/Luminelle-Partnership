...
| 181 | Client | Multi-buy discount codes don’t apply at checkout (tiered discounts requested) | 0 | NEEDS_DECISION | [issue-181](ui-issues/issue-181.md) |
| 182 | Client | Drawer checkout CTA is stuck on “Preparing checkout…” (no working “Go to checkout”) | 0 | PLANNED | [issue-182](ui-issues/issue-182.md) |
| 183 | Client | Mobile account + footer has weird padding / horizontal scroll (should not scroll sideways) | 0 | NOT_AN_ISSUE | [issue-183](ui-issues/issue-183.md) |
| 184 | Platform | `/api/storefront/*` endpoints return 500 (Cloudflare Worker 1101) — cart create, landing sections, product fetch | 0 | PLANNED | [issue-184](ui-issues/issue-184.md) |
| 185 | Client | Entire site allows horizontal scrolling on mobile (layout should be flush + centered) | 0 | PLANNED | [issue-185](ui-issues/issue-185.md) |
| 186 | Client | “Trusted by 10k users” avatars repeat (needs more authentic social proof) | 0 | NEEDS_DECISION | [issue-186](ui-issues/issue-186.md) |
| 187 | Client | Landing reviews section feels bland on desktop (needs higher-impact design) | 0 | NEEDS_DECISION | [issue-187](ui-issues/issue-187.md) |
| 188 | Client | Spin wheel needs visible % labels + “Congrats! You’ve won 20% off…” popup | 0 | NEEDS_DECISION | [issue-188](ui-issues/issue-188.md) |
| 189 | Client | Account “Payment methods” has dev artifacts; consider removing or simplifying (Shopify is the payment source-of-truth) | 0 | NEEDS_DECISION | [issue-189](ui-issues/issue-189.md) |
| 190 | Client | WhatsApp + email support links need to be verified/simplified | 0 | PLANNED | [issue-190](ui-issues/issue-190.md) |
| 192 | Client | Landing “creators” section copy should be customer-focused + “Join creators” CTA should become “Learn more” (blog link) | 0 | PLANNED | [issue-192](ui-issues/issue-192.md) |
...
| 181 | Client | Multi-buy discount codes don’t apply at checkout (tiered discounts requested) | 4 | 4 | 3 | 2 | 0 | NEEDS_DECISION | [issue-181](ui-issues/issue-181.md) |
| 182 | Client | Drawer checkout CTA is stuck on “Preparing checkout…” (no working “Go to checkout”) | 5 | 5 | 3 | 2 | 0 | PLANNED | [issue-182](ui-issues/issue-182.md) |
| 183 | Client | Mobile account + footer has weird padding / horizontal scroll (should not scroll sideways) | 3 | 5 | 2 | 2 | 0 | NOT_AN_ISSUE | [issue-183](ui-issues/issue-183.md) |
| 184 | Platform | `/api/storefront/*` endpoints return 500 (Cloudflare Worker 1101) — cart create, landing sections, product fetch | 5 | 5 | 2 | 3 | 0 | PLANNED | [issue-184](ui-issues/issue-184.md) |
| 185 | Client | Entire site allows horizontal scrolling on mobile (layout should be flush + centered) | 4 | 5 | 2 | 2 | 0 | PLANNED | [issue-185](ui-issues/issue-185.md) |
| 186 | Client | “Trusted by 10k users” avatars repeat (needs more authentic social proof) | 2 | 5 | 2 | 2 | 0 | NEEDS_DECISION | [issue-186](ui-issues/issue-186.md) |
| 187 | Client | Landing reviews section feels bland on desktop (needs higher-impact design) | 3 | 5 | 3 | 2 | 0 | NEEDS_DECISION | [issue-187](ui-issues/issue-187.md) |
| 188 | Client | Spin wheel needs visible % labels + “Congrats! You’ve won 20% off…” popup | 3 | 4 | 3 | 2 | 0 | NEEDS_DECISION | [issue-188](ui-issues/issue-188.md) |
| 189 | Client | Account “Payment methods” has dev artifacts; consider removing or simplifying (Shopify is the payment source-of-truth) | 3 | 3 | 2 | 2 | 0 | NEEDS_DECISION | [issue-189](ui-issues/issue-189.md) |
| 190 | Client | WhatsApp + email support links need to be verified/simplified | 3 | 4 | 1 | 2 | 0 | PLANNED | [issue-190](ui-issues/issue-190.md) |
...
| 192 | Client | Landing “creators” section copy should be customer-focused + “Join creators” CTA should become “Learn more” (blog link) | 2 | 4 | 1 | 2 | 0 | PLANNED | [issue-192](ui-issues/issue-192.md) |
