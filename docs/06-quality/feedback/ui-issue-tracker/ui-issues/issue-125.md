...
Source audit: `docs/06-quality/reviews/app-ui-review-2025-12-26.md` — issue `125`
...
Audit (issue 125): `docs/06-quality/reviews/app-ui-review-2025-12-26.md` — “The ‘Sign up’ page uses the `signIn` Clerk API”.
...
- Audit: `docs/06-quality/reviews/app-ui-review-2025-12-26.md` (issue 125)
- Code refs:
