...
Source audit: `docs/06-quality/reviews/app-ui-review-2025-12-26.md` — issue `15`
...
Audit (issue 15): `docs/06-quality/reviews/app-ui-review-2025-12-26.md` — “Drawer accessibility is incomplete (labeling + tab semantics + focus handling)”.
...
- Audit: `docs/06-quality/reviews/app-ui-review-2025-12-26.md` (issue 15)
- Code refs:
