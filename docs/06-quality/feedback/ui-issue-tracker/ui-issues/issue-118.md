...
Source audit: `docs/06-quality/reviews/app-ui-review-2025-12-26.md` — issue `118`
...
Audit claim (Issue 118): `docs/06-quality/reviews/app-ui-review-2025-12-26.md` notes social URL constants exist but some UI/presets hard-code URLs instead.
