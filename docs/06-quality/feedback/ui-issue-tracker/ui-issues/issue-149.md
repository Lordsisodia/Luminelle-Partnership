...
Source audit: `docs/06-quality/reviews/app-ui-review-2025-12-26.md` — issue `149`
...
Audit (issue 149): `docs/06-quality/reviews/app-ui-review-2025-12-26.md` — “App-level `Suspense` fallback removes the site chrome”.
...
- Audit: `docs/06-quality/reviews/app-ui-review-2025-12-26.md` (issue 149)
- Code refs:
