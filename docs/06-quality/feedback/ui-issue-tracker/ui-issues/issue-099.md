...
Source audit: `docs/06-quality/reviews/app-ui-review-2025-12-26.md` — issue `99`
...
Audit claim (Issue 99): `docs/06-quality/reviews/app-ui-review-2025-12-26.md` calls out blog footer using `hello@lumelle.com` while site constants use `info@lumellebeauty.co.uk`, and `index.html` JSON‑LD `sameAs` using `lumellehair` while the footer links to `lumelleuk`.
