...
Source audit: `docs/06-quality/reviews/app-ui-review-2025-12-26.md` — issue `94`
...
Audit (issue 94): `docs/06-quality/reviews/app-ui-review-2025-12-26.md` — “Cart stepper controls and promo input lack accessible labels”.
...
- Audit: `docs/06-quality/reviews/app-ui-review-2025-12-26.md` (issue 94)
- Code refs:
