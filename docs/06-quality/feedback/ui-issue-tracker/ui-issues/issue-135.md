...
Source audit: `docs/06-quality/reviews/app-ui-review-2025-12-26.md` — issue `135`
...
Audit (issue 135): `docs/06-quality/reviews/app-ui-review-2025-12-26.md` — “`Seo` allows relative `og:image` / `twitter:image` URLs”.
...
- Audit: `docs/06-quality/reviews/app-ui-review-2025-12-26.md` (issue 135)
- Code refs:
