# Issue 066: Admin blog editor inputs are not wired to the “draft” state and preview is not a live draft

Source audit: `docs/06-quality/reviews/app-ui-review-2025-12-26.md` — issue `66`
