...
This file records the calibrated first-pass scoring for issues `1–180` in `docs/06-quality/reviews/app-ui-review-2025-12-26.md`.

Scales (see `docs/06-quality/feedback/ui-issue-tracker/ai-loop.md`):
- Impact: 1–5
- Reach: 1–5
- Effort: 1–5
- Confidence: 1–3
