...
- [x] (#3) Orders list/detail pages are stubbed (“temporarily unavailable”); replace with branded pages or link out to Shopify order status. — Black-box: `DONE` ([issue-003](../ui-issue-tracker/done-issues/issue-003.md))
