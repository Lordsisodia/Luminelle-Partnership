# Client — Account addresses (Feedback)
...
- [x] (#3) Addresses page is stubbed (“temporarily unavailable”); either implement or hide until supported. — Black-box: `DONE` ([issue-003](../ui-issue-tracker/done-issues/issue-003.md))
