...
- [x] (#27) Privacy page links users to `/returns` and other support routes that may be stubbed; avoid linking to broken destinations. — Black-box: `DONE` ([issue-027](../ui-issue-tracker/ui-issues/issue-027.md))
