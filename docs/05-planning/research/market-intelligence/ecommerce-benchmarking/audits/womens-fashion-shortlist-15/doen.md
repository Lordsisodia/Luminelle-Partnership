...
Bot defense (from HTML snapshots): 6/6 pages blocked (~100%).

Target URLs (use these to speed-run the funnel):
- cart: `https://www.doen.com/cart` (batch-03)
- home: `https://www.doen.com` (batch-03)
- plp_dresses: `https://www.doen.com/collections/dresses` (batch-03)
- plp_new_arrivals: `https://www.doen.com/collections/new-arrivals` (batch-03)
- shipping_returns: `https://www.doen.com/pages/shipping-returns` (batch-03)
- size_guide: `https://www.doen.com/pages/size-guide` (batch-03)

Detected tooling / signals (union across snapshots):
- platform: magento
- ux_keywords: returns_exchanges, sustainability
