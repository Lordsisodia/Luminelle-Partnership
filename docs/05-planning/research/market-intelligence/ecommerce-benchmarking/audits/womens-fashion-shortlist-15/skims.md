...
- home: `https://skims.com` (batch-01)
- pdp_tshirt_bra: `https://skims.com/products/fits-everybody-t-shirt-bra-onyx` (batch-01)
- plp_best_sellers: `https://skims.com/collections/best-sellers` (batch-01)
- returns: `https://skims.com/pages/returns` (batch-01)
- shipping: `https://skims.com/pages/shipping` (batch-01)
- size_guides: `https://skims.com/pages/size-guides` (batch-01)
...
- Shipping threshold messaging exists in the shipping page metadata:
  - “free shipping on all orders over $75 in the U.S.” (evidence: `.blackbox/.plans/2025-12-29_0552_deep-research-ecommerce-benchmark-manual-funnel-audits/artifacts/snapshots/batch-01/20251229T114102Z__skims-shipping.html`)
- Reviews provider and scale are strongly indicated via Okendo payloads (rating + reviewCount):
  - evidence: `.blackbox/.plans/2025-12-29_0552_deep-research-ecommerce-benchmark-manual-funnel-audits/artifacts/snapshots/batch-01/20251229T114102Z__skims-pdp-tshirt-bra.html`
- Personalization tooling is present (Dynamic Yield scripts):
  - evidence: `.blackbox/.plans/2025-12-29_0552_deep-research-ecommerce-benchmark-manual-funnel-audits/artifacts/snapshots/batch-01/20251229T114102Z__skims-shipping.html`
- Internationalization / global checkout tooling is present (Global-e storefront script):
  - evidence: `.blackbox/.plans/2025-12-29_0552_deep-research-ecommerce-benchmark-manual-funnel-audits/artifacts/snapshots/batch-01/20251229T114102Z__skims-shipping.html`
- Returns experience appears to include a dedicated returns portal and carrier flow:
  - `returns.skims.com` and “Track a DHL Return” links are present (evidence: `.blackbox/.plans/2025-12-29_0552_deep-research-ecommerce-benchmark-manual-funnel-audits/artifacts/snapshots/batch-01/20251229T114102Z__skims-returns.html`)
