...
- Niche: Luxury/streetwear marketplace
- Price point:
...
Bot defense (from HTML snapshots): 7/7 pages blocked (~100%).

Target URLs (use these to speed-run the funnel):
- customer_service: `https://www.ssense.com/en-us/customer-service` (batch-03)
- home: `https://www.ssense.com` (batch-03)
- home_en_us: `https://www.ssense.com/en-us` (batch-03)
- plp_clothing: `https://www.ssense.com/en-us/women/clothing` (batch-03)
- returns: `https://www.ssense.com/en-us/returns` (batch-03)
- shipping: `https://www.ssense.com/en-us/shipping` (batch-03)
- women_home: `https://www.ssense.com/en-us/women` (batch-03)

Detected tooling / signals (union across snapshots):
- platform: magento
- ux_keywords: returns_exchanges

Audit notes:
- High bot protection observed in snapshots — plan to do this audit fully manual and mark `blocked=true` if needed.
