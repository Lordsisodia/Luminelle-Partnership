...
- cart_or_checkout: `https://www.rouje.com/cart` (batch-03)
- help_support: `https://www.rouje.com/pages/contact-us` (batch-03)
- home: `https://www.rouje.com` (batch-03)
- pdp: `https://www.rouje.com/products/palo-bag` (batch-03)
- plp: `https://www.rouje.com/collections/new-in` (batch-03)
- returns: `https://www.rouje.com/a/return?utm_geoip=1` (batch-03)
- size_fit: `https://www.rouje.com/pages/size-guide` (batch-03)

Detected tooling / signals (union across snapshots):
- platform: magento, shopify
- bnpl: klarna
- reviews: judge_me, okendo, yotpo
- support: gorgias, zendesk
- tracking: gtm
- ux_keywords: free_shipping, newsletter_signup, size_fit, sustainability
...
- Reviews tooling appears “multi-provider” on the PDP (Okendo variables + Yotpo payload present in HTML):
...
- Size/fit is treated as a first-class page with strong SEO metadata and footer navigation that includes return management (“Gérer mon retour”):
...
- Cart snapshot is extremely minimal and indicates an empty cart payload (likely requires cookies/session; validate manually in-browser):
