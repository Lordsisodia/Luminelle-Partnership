...
- collection: `https://frankiesbikinis.com/collections/best-sellers` (top25-apparel)
- product: `https://frankiesbikinis.com/products/gift-card` (top25-apparel)
- returns: `https://frankiesbikinis.com/pages/returns` (top25-apparel)
- shipping: `https://frankiesbikinis.com/pages/shipping` (top25-apparel)
- sizing: `https://frankiesbikinis.com/pages/fit-guide` (top25-apparel)
- support: `https://frankiesbikinis.com/pages/contact` (top25-apparel)
- cart: `https://frankiesbikinis.com/cart` (top25-apparel-cartcheckout)
- checkout: `https://frankiesbikinis.com/checkout` (top25-apparel-cartcheckout)
