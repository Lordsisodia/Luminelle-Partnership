...
- collection: `https://www.aloyoga.com/en-vn/collections/bestsellers` (top25-apparel)
- returns: `https://www.aloyoga.com/pages/returns-support` (top25-apparel)
- sizing: `https://www.aloyoga.com/en-vn/pages/size-chart` (top25-apparel)
- support: `https://www.aloyoga.com/pages/help-center` (top25-apparel)
- cart: `https://www.aloyoga.com/cart` (top25-apparel-cartcheckout)
- checkout: `https://www.aloyoga.com/checkout` (top25-apparel-cartcheckout)
