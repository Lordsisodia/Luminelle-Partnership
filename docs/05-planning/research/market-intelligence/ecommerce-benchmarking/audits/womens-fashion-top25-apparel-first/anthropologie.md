...
- Niche: Boho womenswear + lifestyle
- Price point:
...
- collection: `https://www.anthropologie.com/new-clothes` (top25-apparel)
- support: `https://www.anthropologie.com/help/bhldn-styling-appointments` (top25-apparel)
- cart: `https://www.anthropologie.com/cart` (top25-apparel-cartcheckout)
- checkout: `https://www.anthropologie.com/checkout` (top25-apparel-cartcheckout)

Detected tooling / signals (union across snapshots):
- platform: magento
- bnpl: affirm, afterpay, klarna
- reviews: bazaarvoice
- subscriptions: subscribe_pro
- ux_keywords: free_shipping, gift_cards, loyalty_rewards, newsletter_signup, returns_exchanges, store_locator, sustainability
