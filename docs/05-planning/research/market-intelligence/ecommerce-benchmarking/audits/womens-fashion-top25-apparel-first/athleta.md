...
- collection: `https://www.athleta.gap.com/browse/new/all-womens?cid=3043230&mlink=1,1,Site_SW_Promo_SWB_SASPhase2_CTA1_122625` (top25-apparel)
- cart: `https://www.athleta.gap.com/cart` (top25-apparel-cartcheckout)
- checkout: `https://www.athleta.gap.com/checkout` (top25-apparel-cartcheckout)

Detected tooling / signals (union across snapshots):
- platform: magento
- bnpl: afterpay, klarna
- returns: happy_returns
