...
- Niche: Premium minimal lingerie
- Price point:
- Archetype: DTC brand
...
- collection: `https://negativeunderwear.com/collections/all` (top25-apparel)
- product: `https://negativeunderwear.com/products/sand-whipped-travel-wrap` (top25-apparel)
- support: `https://negativeunderwear.com/pages/help-center?hcUrl=%2Fen-US` (top25-apparel)
- cart: `https://negativeunderwear.com/cart` (top25-apparel-cartcheckout)
- checkout: `https://negativeunderwear.com/checkout` (top25-apparel-cartcheckout)
