...
- Niche: Basics and functional apparel
- Price point:
...
Bot defense (from HTML snapshots): 2/8 pages blocked (~25%).

Target URLs (use these to speed-run the funnel):
- collection: `https://www.uniqlo.com/us/en/feature/new/women` (top25-apparel)
- product: `https://www.uniqlo.com/us/en/products/E445174-000/00` (top25-apparel)
- returns: `https://www.uniqlo.com/us/en/help/returns` (top25-apparel)
- shipping: `https://www.uniqlo.com/us/en/help/shipping` (top25-apparel)
- sizing: `https://www.uniqlo.com/us/en/size-chart` (top25-apparel)
- support: `https://www.uniqlo.com/us/en/help/contact-us` (top25-apparel)
- cart: `https://www.uniqlo.com/cart` (top25-apparel-cartcheckout)
- checkout: `https://www.uniqlo.com/checkout` (top25-apparel-cartcheckout)
