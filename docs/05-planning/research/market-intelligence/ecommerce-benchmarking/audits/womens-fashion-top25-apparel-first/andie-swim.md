...
- collection: `https://andieswim.com/collections/new-arrivals` (top25-apparel)
- product: `https://andieswim.com/products/the-amalfi-flat-black-classic` (top25-apparel)
- returns: `https://andieswim.com/pages/returns` (top25-apparel)
- shipping: `https://andieswim.com/policies/shipping-policy` (top25-apparel)
- sizing: `https://andieswim.com/pages/us-size-chart` (top25-apparel)
- support: `https://andieswim.com/pages/faq` (top25-apparel)
- cart: `https://andieswim.com/cart` (top25-apparel-cartcheckout)
- checkout: `https://andieswim.com/checkout` (top25-apparel-cartcheckout)
