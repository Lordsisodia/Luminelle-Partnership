...
- Niche: Youth fashion + streetwear
- Price point:
...
- collection: `https://www.urbanoutfitters.com/new-arrivals` (top25-apparel)
- cart: `https://www.urbanoutfitters.com/cart` (top25-apparel-cartcheckout)
- checkout: `https://www.urbanoutfitters.com/checkout` (top25-apparel-cartcheckout)
