...
- collection: `https://www.thirdlove.com/collections/all-bras-underwear` (top25-apparel)
- product: `https://www.thirdlove.com/products/24-7-classic-t-shirt-bra-taupe` (top25-apparel)
- returns: `https://www.thirdlove.com/pages/returns-center` (top25-apparel)
- sizing: `https://www.thirdlove.com/pages/fitting-room` (top25-apparel)
- cart: `https://www.thirdlove.com/cart` (top25-apparel-cartcheckout)
- checkout: `https://www.thirdlove.com/checkout` (top25-apparel-cartcheckout)
