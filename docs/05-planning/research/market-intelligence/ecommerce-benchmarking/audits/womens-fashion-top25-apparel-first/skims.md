...
- collection: `https://skims.com/collections/new-arrivals` (top25-apparel)
- product: `https://skims.com/products/cotton-jersey-long-sleeve-t-shirt-marble` (top25-apparel)
- returns: `https://skims.com/pages/returns` (top25-apparel)
- shipping: `https://skims.com/pages/shipping` (top25-apparel)
- sizing: `https://skims.com/pages/size-guides` (top25-apparel)
- support: `https://skims.com/pages/faqs` (top25-apparel)
- cart: `https://skims.com/cart` (top25-apparel-cartcheckout)
- checkout: `https://skims.com/checkout` (top25-apparel-cartcheckout)
