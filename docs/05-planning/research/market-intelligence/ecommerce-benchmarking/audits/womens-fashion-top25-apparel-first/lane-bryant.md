...
- collection: `https://www.lanebryant.com/new` (top25-apparel)
- sizing: `https://www.lanebryant.com/content/fit-experts` (top25-apparel)
- support: `https://www.lanebryant.com/help/loyalty-terms-and-conditions?intid=lb_disclaimers_rewards_20251226` (top25-apparel)
- cart: `https://www.lanebryant.com/cart` (top25-apparel-cartcheckout)
- checkout: `https://www.lanebryant.com/checkout` (top25-apparel-cartcheckout)
