...
- collection: `https://www.saksfifthavenue.com/c/custom/email-events/best-sellers/women-s-clothing` (top25-apparel)
- returns: `https://www.saksfifthavenue.com/c/content/returns-exchanges?sre=FOOTER^1^3^AW^RETURNS^2023^NULL^NULL^NULL` (top25-apparel)
- shipping: `https://www.saksfifthavenue.com/c/content/shipping-policy?sre=FOOTER^1^4^AW^SHIPPINGPOLICY^2023^NULL^NULL^NULL` (top25-apparel)
- cart: `https://www.saksfifthavenue.com/cart` (top25-apparel-cartcheckout)
- checkout: `https://www.saksfifthavenue.com/checkout` (top25-apparel-cartcheckout)

Detected tooling / signals (union across snapshots):
- platform: magento
- search_personalization: dynamic_yield
- tracking: gtm
- ux_keywords: free_shipping, gift_cards, loyalty_rewards, newsletter_signup, returns_exchanges, sustainability
