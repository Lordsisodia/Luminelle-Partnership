...
- collection: `https://www.pinkblushmaternity.com/collections/maternity-whats-new` (top25-apparel)
- returns: `https://www.pinkblushmaternity.com/pages/return-policy` (top25-apparel)
- shipping: `https://www.pinkblushmaternity.com/pages/shipping` (top25-apparel)
- support: `https://www.pinkblushmaternity.com/pages/contact-us` (top25-apparel)
- cart: `https://www.pinkblushmaternity.com/cart` (top25-apparel-cartcheckout)
- checkout: `https://www.pinkblushmaternity.com/checkout` (top25-apparel-cartcheckout)
