...
- collection: `https://triangl.com/collections/all` (top25-apparel)
- returns: `https://triangl.com/a/returns` (top25-apparel)
- sizing: `https://triangl.com/pages/size-guide` (top25-apparel)
- support: `https://triangl.com/pages/faqs?tab=contact` (top25-apparel)
- cart: `https://triangl.com/cart` (top25-apparel-cartcheckout)
- checkout: `https://triangl.com/checkout` (top25-apparel-cartcheckout)
...
- ux_keywords: free_shipping, newsletter_signup, returns_exchanges, size_fit, sustainability
