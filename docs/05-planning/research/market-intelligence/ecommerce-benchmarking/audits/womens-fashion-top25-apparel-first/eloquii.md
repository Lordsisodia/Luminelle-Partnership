...
- collection: `https://www.eloquii.com/zq/new/?ICID=NB|40OFF|CTA1|6-5-2023` (top25-apparel)
- product: `https://www.eloquii.com/products/eloquii-e-gift-cards/5000078.html` (top25-apparel)
- support: `https://www.eloquii.com/help-page?cid=sa-custservice-returnexchange` (top25-apparel)
- cart: `https://www.eloquii.com/cart` (top25-apparel-cartcheckout)
- checkout: `https://www.eloquii.com/checkout` (top25-apparel-cartcheckout)

Detected tooling / signals (union across snapshots):
- platform: magento
- bnpl: affirm
- returns: happy_returns, narvar
