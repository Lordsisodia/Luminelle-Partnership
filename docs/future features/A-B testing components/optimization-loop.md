...
- Hybrid plan: `docs/future features/A-B testing components/hybrid-analytics-heatmaps-stack.md`
- First experiment: `docs/future features/A-B testing components/first-experiment-spec.md`
- QA + privacy: `docs/future features/A-B testing components/qa-checklist.md`, `privacy-consent.md`
