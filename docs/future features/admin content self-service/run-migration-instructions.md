...
- SQL file: `docs/future features/admin content self-service/sql-migration-draft.sql`.
...
2) Run migration:
   ```bash
   supabase db execute --file "docs/future features/admin content self-service/sql-migration-draft.sql"
   ```
